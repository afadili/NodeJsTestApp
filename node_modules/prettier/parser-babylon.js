!(function(t, e) {
  ...
  var i = s(function(t) {
    ...
    r = { EOL: "\n" },
    a = Object.freeze({ default: r }),
    n = (a && r) || a,
    o = s(function(t, e) {
      var s, r;
      function a() {
        return (s = (t = i) && t.__esModule ? t : { default: t });
        var t;
      }
      function o() {
        return (r = n);
      ...
      function y(t) {
        ...
        for (
          ...
          var D = n[2].replace(c, "");
          "string" == typeof p[n[1]] || Array.isArray(p[n[1]])
            ? (p[n[1]] = [].concat(p[n[1]], D))
            : (p[n[1]] = D);
        }
        return { comments: y, pragmas: p };
      }
      function D(t, e) {
  ...
  var l = s(function(t) {
    ...
    f = s(function(t) {
      ...
      t.exports = function(t) {
        if ("string" != typeof (t = t.replace(e, "  ")) || 0 === t.length)
          return 0;
        t = (function(t) {
        ...
        for (var s = 0, i = 0; i < t.length; i++) {
          ...
          r <= 31 ||
            (r >= 127 && r <= 159) ||
            ((r >= 768 && r <= 879) || (r > 65535 && i++, (s += d(r) ? 2 : 1)));
        }
        return s;
      };
    }),
  ...
  function E(t, e) {
    return (
      !1 !== e && ("/" === t.charAt(e) && "/" === t.charAt(e + 1) ? C(t, e) : e)
    );
  }
  function A(t, e, s) {
    var i = s && s.backwards;
  ...
  function B(t, e) {
    var s = t.slice(1, -1),
      ...
      n = a === r ? i : r,
      o = a.quote;
    (s.includes(a.quote) || s.includes(n.quote)) &&
      (o =
  ...
  var U = {
    ...
    getMinNotPresentContinuousCount: function(t, e) {
      ...
      for (var c = 1; c < r; c++) if (!i.get(c)) return c;
      return r + 1;
    },
    getPrecedence: I,
    ...
    isPreviousLineEmpty: function(t, e, s) {
      var i = s(e) - 1;
      return (
        (i = A(t, (i = g(t, i, { backwards: !0 })), { backwards: !0 })),
        (i = g(t, i, { backwards: !0 })) !== A(t, i, { backwards: !0 })
      );
    },
    hasNewline: T,
  ...
  var V = function(t, e) {
    ...
    W = s(function(t, e) {
      function s(t) {
        ...
        (this._invoke = function(t, r) {
          return new Promise(function(a, n) {
            var o = { key: t, arg: r, resolve: a, reject: n, next: null };
      ...
      var r = !0,
        a = function(t, e) {
          void 0 === e && (e = {}),
            ...
            (this.binop = 0 === e.binop ? 0 : e.binop || null),
            (this.updateContext = null);
        };
      function n(t, e) {
        return (
          void 0 === e && (e = {}),
          new a(t, Object.assign({}, e, { keyword: t }))
        );
      }
      function o(t, e) {
      ...
      var h = {
          ...
          eof: new a("eof"),
          bracketL: new a("[", { beforeExpr: r, startsExpr: !0 }),
          bracketR: new a("]"),
          braceL: new a("{", { beforeExpr: r, startsExpr: !0 }),
          braceBarL: new a("{|", { beforeExpr: r, startsExpr: !0 }),
          braceR: new a("}"),
          braceBarR: new a("|}"),
          parenL: new a("(", { beforeExpr: r, startsExpr: !0 }),
          parenR: new a(")"),
          ...
          dollarBraceL: new a("${", { beforeExpr: r, startsExpr: !0 }),
          at: new a("@"),
          hash: new a("#"),
          interpreterDirective: new a("#!..."),
          eq: new a("=", { beforeExpr: r, isAssign: !0 }),
          assign: new a("_=", { beforeExpr: r, isAssign: !0 }),
          incDec: new a("++/--", { prefix: !0, postfix: !0, startsExpr: !0 }),
          bang: new a("!", { beforeExpr: r, prefix: !0, startsExpr: !0 }),
          tilde: new a("~", { beforeExpr: r, prefix: !0, startsExpr: !0 }),
          pipeline: new o("|>", 0),
        ...
        u = {
          break: new n("break"),
          case: new n("case", { beforeExpr: r }),
          catch: new n("catch"),
          continue: new n("continue"),
          debugger: new n("debugger"),
          default: new n("default", { beforeExpr: r }),
          do: new n("do", { isLoop: !0, beforeExpr: r }),
          else: new n("else", { beforeExpr: r }),
          finally: new n("finally"),
          for: new n("for", { isLoop: !0 }),
          function: new n("function", { startsExpr: !0 }),
          if: new n("if"),
          return: new n("return", { beforeExpr: r }),
          switch: new n("switch"),
          throw: new n("throw", { beforeExpr: r, prefix: !0, startsExpr: !0 }),
          try: new n("try"),
          var: new n("var"),
          let: new n("let"),
          const: new n("const"),
          ...
          with: new n("with"),
          new: new n("new", { beforeExpr: r, startsExpr: !0 }),
          this: new n("this", { startsExpr: !0 }),
          super: new n("super", { startsExpr: !0 }),
          class: new n("class", { startsExpr: !0 }),
          extends: new n("extends", { beforeExpr: r }),
          export: new n("export"),
          import: new n("import", { startsExpr: !0 }),
          yield: new n("yield", { beforeExpr: r, startsExpr: !0 }),
          null: new n("null", { startsExpr: !0 }),
          true: new n("true", { startsExpr: !0 }),
          false: new n("false", { startsExpr: !0 }),
          in: new n("in", { beforeExpr: r, binop: 7 }),
          instanceof: new n("instanceof", { beforeExpr: r, binop: 7 }),
          typeof: new n("typeof", {
            beforeExpr: r,
            prefix: !0,
            startsExpr: !0
          }),
          void: new n("void", { beforeExpr: r, prefix: !0, startsExpr: !0 }),
          delete: new n("delete", { beforeExpr: r, prefix: !0, startsExpr: !0 })
        };
      function p(t) {
        return (
          null != t &&
      ...
      (h.parenR.updateContext = h.braceR.updateContext = function() {
        ...
        (h.name.updateContext = function(t) {
          ...
          t !== h.dot &&
            (("of" === this.state.value && !this.state.exprAllowed) ||
              ("yield" === this.state.value && this.state.inGenerator)) &&
            (e = !0),
        ...
        (h.braceL.updateContext = function(t) {
          this.state.context.push(
            this.braceIsBlock(t) ? D.braceStatement : D.braceExpression
          ),
            (this.state.exprAllowed = !0);
        }),
        (h.dollarBraceL.updateContext = function() {
          this.state.context.push(D.templateQuasi),
            (this.state.exprAllowed = !0);
        }),
        (h.parenL.updateContext = function(t) {
          var e =
            t === h._if || t === h._for || t === h._with || t === h._while;
          this.state.context.push(e ? D.parenStatement : D.parenExpression),
            (this.state.exprAllowed = !0);
        }),
        ...
        (h._function.updateContext = h._class.updateContext = function(t) {
          ...
          ((t === h.colon || t === h.braceL) && this.curContext() === D.b_stat)
            ? this.state.context.push(D.functionStatement)
            : this.state.context.push(D.functionExpression),
            (this.state.exprAllowed = !1);
        }),
        (h.backQuote.updateContext = function() {
          this.curContext() === D.template
            ? this.state.context.pop()
            : this.state.context.push(D.template),
            (this.state.exprAllowed = !1);
        });
      var v = {
          6: x("enum await"),
      ...
      function j(t) {
        ...
        if ("JSXMemberExpression" === t.type)
          return j(t.object) + "." + j(t.property);
        throw new Error("Node had unexpected type: " + t.type);
      }
      (D.j_oTag = new y("<tag", !1)),
        (D.j_cTag = new y("</tag", !1)),
        (D.j_expr = new y("<tag>...</tag>", !0, !0)),
        ...
        (h.jsxTagStart.updateContext = function() {
          this.state.context.push(D.j_expr),
            this.state.context.push(D.j_oTag),
            (this.state.exprAllowed = !1);
        }),
        (h.jsxTagEnd.updateContext = function(t) {
          var e = this.state.context.pop();
          (e === D.j_oTag && t === h.slash) || e === D.j_cTag
            ? (this.state.context.pop(),
              (this.state.exprAllowed = this.curContext() === D.j_expr))
            : (this.state.exprAllowed = !0);
        });
      var q = {
        sourceType: "script",
      ...
      var K = (function(t) {
          ...
          return (
            i(e, t),
            (e.prototype.raise = function(t, e, s) {
              var i = void 0 === s ? {} : s,
            ...
            return (
              ...
              (s.processComment = function(t) {
                if (!("Program" === t.type && t.body.length > 0)) {
                  ...
                  for (
                    n.length > 0 && W(n).start >= t.start && (e = n.pop());
                    n.length > 0 && W(n).start >= t.start;

                  )
                    s = n.pop();
                  if (
                    (!s && e && (s = e),
                    e && this.state.leadingComments.length > 0)
                  ) {
                    ...
                    if ("ObjectProperty" === e.type) {
                      if (
                        ...
                        this.state.leadingComments.length > 0 &&
                          ((e.trailingComments = this.state.leadingComments),
                  ...
                  if (s) {
                    if (s.leadingComments)
                      if (
                        ...
                        W(s.leadingComments).end <= t.start
                      )
                    ...
                    if (W(this.state.leadingComments).end <= t.start) {
                      ...
                      for (
                        ...
                        !(this.state.leadingComments[r].end > t.start);
                        r++
                      );
                      var p = this.state.leadingComments.slice(0, r);
                      p.length && (t.leadingComments = p),
                        0 ===
                          (i = this.state.leadingComments.slice(r)).length &&
                          (i = null);
                    }
                  (this.state.commentPreviousNode = t),
                    i &&
                      (i.length && i[0].start >= t.start && W(i).end <= t.end
                        ? (t.innerComments = i)
      ...
      var z = (function(t) {
          ...
          return (
            ...
            (s.unexpected = function(t, e) {
              throw (void 0 === e && (e = "Unexpected token"),
              "string" != typeof e &&
          ...
          (function(t) {
            function e(e, s) {
              var i;
              return (
                ((i = t.call(this) || this).state = new G()),
                i.state.init(e, s),
                (i.isLookahead = !1),
                i
              );
            ...
            return (
                  ...
                  this.state.tokens.push(
                    new (function(t) {
                      (this.type = t.type),
                        ...
                        (this.start = t.start),
                        (this.end = t.end),
                        (this.loc = new V(t.startLoc, t.endLoc));
                    })(this.state)
                  ),
              ...
              (s.skipBlockComment = function() {
                ...
                for (
                  -1 === i &&
                    ...
                    this.state.pos = i + 2,
                    l.lastIndex = s;
                  (t = l.exec(this.input)) && t.index < this.state.pos;
              ...
              (s.readToken_numberSign = function() {
                if (0 !== this.state.pos || !this.readToken_interpreter()) {
                  ...
                  if (
                    ...
                    return ++this.state.pos, void this.finishToken(h.hash);
                  "smart" ===
                  this.getPluginOption("pipelineOperator", "proposal")
                    ? this.finishOp(h.hash, 1)
              ...
              (s.readToken_pipe_amp = function(t) {
                ...
                if (e !== t) {
                  if (124 === t) {
                    ...
                    if (125 === e && this.hasPlugin("flow"))
                      return void this.finishOp(h.braceBarR, 2);
                  }
                  61 !== e
                    ? this.finishOp(124 === t ? h.bitwiseOR : h.bitwiseAND, 1)
                    : this.finishOp(h.assign, 2);
                } else
                  61 === this.input.charCodeAt(this.state.pos + 2)
                    ? this.finishOp(h.assign, 3)
                    : this.finishOp(124 === t ? h.logicalOR : h.logicalAND, 2);
              }),
                ...
                return e === t
                  ? ((s =
                    ...
                    61 === this.input.charCodeAt(this.state.pos + s)
                      ? void this.finishOp(h.assign, s + 1)
                      : void this.finishOp(h.bitShift, s))
                  : 33 !== e ||
                    60 !== t ||
                    this.inModule ||
                    45 !== this.input.charCodeAt(this.state.pos + 2) ||
                    45 !== this.input.charCodeAt(this.state.pos + 3)
                  ? (61 === e && (s = 2), void this.finishOp(h.relational, s))
              ...
              (s.readToken_eq_excl = function(t) {
                ...
                if (61 !== e)
                  return 61 === t && 62 === e
                    ? ((this.state.pos += 2), void this.finishToken(h.arrow))
              ...
              (s.getTokenFromCode = function(t) {
                switch (t) {
                  ...
                  case 123:
                    ...
                    124 === this.input.charCodeAt(this.state.pos + 1)
                      ...
                      : (++this.state.pos, this.finishToken(h.braceL)));
                  case 125:
                ...
                this.raise(
                  this.state.pos,
                  "Unexpected character '" + String.fromCodePoint(t) + "'"
                );
              }),
              ...
              (s.readRadixNumber = function(t) {
                ...
                if (
                  ...
                  this.hasPlugin("bigInt") &&
                    ...
                    (++this.state.pos, (s = !0)),
                  N(this.input.codePointAt(this.state.pos)) &&
                    this.raise(
                      this.state.pos,
              ...
              (s.readNumber = function(t) {
                ...
                r &&
                  ...
                  /[89]/.test(this.input.slice(e, this.state.pos)) && (r = !1));
                ...
                46 !== a ||
                  ...
                  (69 !== a && 101 !== a) ||
                    r ||
                    ((43 !== (a = this.input.charCodeAt(++this.state.pos)) &&
                      45 !== a) ||
                      ++this.state.pos,
                    null === this.readInt(10) &&
                      this.raise(e, "Invalid number"),
                  ...
                  this.hasPlugin("bigInt") &&
                    110 === a &&
                    ((s || r) && this.raise(e, "Invalid BigIntLiteral"),
                    ++this.state.pos,
                    (i = !0)),
                  N(this.input.codePointAt(this.state.pos)) &&
                    this.raise(
                ...
                var n = this.input
                  .slice(e, this.state.pos)
                  .replace(/[_n]/g, "");
                if (i) this.finishToken(h.bigint, n);
                else {
                  ...
                  if (
                    ...
                    return this.state.pos === this.state.start &&
                      ...
                      : ((t += this.input.slice(e, this.state.pos)),
                        void this.finishToken(h.template, s ? null : t));
                  if (92 === i) {
                    t += this.input.slice(e, this.state.pos);
              ...
              (s.readWord1 = function() {
                ...
                for (
                  ...
                  if (k(i)) this.state.pos += i <= 65535 ? 1 : 2;
              ...
              (s.braceIsBlock = function(t) {
                ...
                return (
                  e === D.functionExpression ||
                  e === D.functionStatement ||
                  (t !== h.colon ||
                      ...
                      : t === h._else ||
                        ...
                        (t === h.braceL
                          ...
                          : t !== h._var &&
                            t !== h._let &&
                            t !== h._const &&
                            (t === h.relational || !this.state.exprAllowed))
                    : !e.isExpr)
                );
              }),
              (s.updateContext = function(t) {
                var e,
                  s = this.state.type;
                !s.keyword || (t !== h.dot && t !== h.questionDot)
                  ? (e = s.updateContext)
                    ? e.call(this, t)
        ...
        et = (function(t) {
          function e(e, s) {
            ...
            return (
              (e = (function(t) {
                var e = {};
                for (var s in q) e[s] = t && null != t[s] ? t[s] : q[s];
                return e;
              })(e)),
              ((i = t.call(this, e, s) || this).options = e),
            ...
            return (
              ...
              (s.parseStatementContent = function(t, e) {
                ...
                switch (s) {
                  ...
                  case h._function:
                    ...
                    return (
                      t || this.unexpected(), this.parseFunctionStatement(i)
                    );
                  case h._class:
                  ...
                  case h.name:
                    if (this.isContextual("async")) {
                      ...
                      if (
                        (this.next(),
                        this.match(h._function) && !this.canInsertSemicolon())
                      )
                        return (
                          this.expect(h._function),
                          this.parseFunction(i, !0, !1, !0)
                        );
                      this.state = n;
                    }
                }
                ...
                return s === h.name &&
                  "Identifier" === u.type &&
                  this.eat(h.colon)
                  ? this.parseLabeledStatement(i, o, u)
              ...
              (s.parseDecorator = function() {
                ...
                if ((this.next(), this.hasPlugin("decorators"))) {
                  ...
                  if (this.eat(h.parenL))
                    (e = this.parseExpression()), this.expect(h.parenR);
                  else
                    for (e = this.parseIdentifier(!1); this.eat(h.dot); ) {
              ...
              (s.parseForStatement = function(t) {
                ...
                if (this.match(h._in) || this.isContextual("of")) {
                  var u = this.isContextual("of")
                    ? "for-of statement"
                    : "for-in statement";
                  return (
                    this.toAssignable(o, void 0, u),
                    this.checkLVal(o, void 0, void 0, u),
              ...
              (s.parseSwitchStatement = function(t) {
                ...
                var e,
                  ...
                  i = (t.cases = []);
                for (
                  this.expect(h.braceL), this.state.labels.push(tt);
                  !this.match(h.braceR);
              ...
              (s.parseTryStatement = function(t) {
                ...
                if (
                  ...
                  if ((this.next(), this.match(h.parenL))) {
                    ...
                    this.checkLVal(s.param, !0, i, "catch clause"),
              ...
              (s.parseLabeledStatement = function(t, e, s) {
                ...
                for (
                  var a = this.state.type.isLoop
                      ? "loop"
                      : this.match(h._switch)
                      ? "switch"
                      : null,
                    n = this.state.labels.length - 1;
                  n >= 0;
                  n--
                ) {
                  ...
                  ("ClassDeclaration" == t.body.type ||
                    ...
                    ("FunctionDeclaration" == t.body.type &&
                      (this.state.strict ||
                        t.body.generator ||
                        t.body.async))) &&
                    this.raise(t.body.start, "Invalid labeled declaration"),
                  this.state.labels.pop(),
                  (t.label = s),
              ...
              (s.parseBlock = function(t) {
                ...
                return (
                  ...
                  this.parseBlockBody(e, t, !1, h.braceR),
              ...
              (s.parseFor = function(t, e) {
                ...
                return (
                  (t.init = e),
                  this.expect(h.semi),
                  (t.test = this.match(h.semi) ? null : this.parseExpression()),
                  this.expect(h.semi),
              ...
              (s.parseForIn = function(t, e, s) {
                ...
                return (
                  s ? this.eatContextual("of") : this.next(),
                  "ForOfStatement" === r && (t.await = !!s),
                  (t.left = e),
              ...
              (s.parseFunction = function(t, e, s, i, r) {
                ...
                return (
                  ...
                  this.match(h.star) && ((t.generator = !0), this.next()),
                  !e ||
                    r ||
                    this.match(h.name) ||
                    this.match(h._yield) ||
                  ...
                  (this.match(h.name) || this.match(h._yield)) &&
                  ...
                  this.withTopicForbiddingContext(function() {
                    a.parseFunctionBodyAndFinish(
                      t,
                      e ? "FunctionDeclaration" : "FunctionExpression",
                      s
                    );
                  }),
                  (this.state.inFunction = n),
                  (this.state.inMethod = o),
                  (this.state.inAsync = u),
                  (this.state.inGenerator = p),
                  (this.state.inClassProperty = c),
                  t
                );
              }),
              (s.parseFunctionParams = function(t, e) {
                ...
                (this.state.inParameters = !0),
                  this.expect(h.parenL),
                  (t.params = this.parseBindingList(h.parenR, !1, e)),
              ...
              (s.isClassProperty = function() {
                return (
                  this.match(h.eq) || this.match(h.semi) || this.match(h.braceR)
                );
              }),
                ...
                (a.body = []),
                  ...
                  this.withTopicForbiddingContext(function() {
                    for (; !e.eat(h.braceR); )
                      ...
                      else if (e.match(h.at)) r.push(e.parseDecorator());
                      else {
                        var t = e.startNode();
                        r.length &&
                          ((t.decorators = r),
                          e.resetStartLocationFromNode(t, r[0]),
                          (r = [])),
                          e.parseClassMember(a, t, i),
                          "constructor" === t.kind &&
                            t.decorators &&
                ...
                if (this.match(h.name) && "static" === this.state.value) {
                  ...
                  if (this.isClassMethod()) {
                    ...
                    return (
                      ...
                      (n.key = a),
                      (n.static = !1),
                      void this.pushClassMethod(t, n, !1, !1, !1)
                    );
                  }
                  if (this.isClassProperty()) {
                    ...
                    return (
                      ...
                      (o.key = a),
                      (o.static = !1),
                      void t.body.push(this.parseClassProperty(o))
                    );
                  }
              ...
              (s.parseClassMemberWithIsStatic = function(t, e, s, i) {
                  ...
                  return (
                    ...
                    "PrivateName" === u.key.type
                      ...
                      : (this.isNonstaticConstructor(r) &&
                        ...
                        void this.pushClassMethod(t, r, !0, !1, !1))
                  );
                ...
                if (
                  ...
                  f &&
                    ...
                    (s.hadConstructor = !0)),
                    this.pushClassMethod(t, r, !1, !1, f);
                } else if (this.isClassProperty())
                  l
                    ? this.pushClassPrivateProperty(t, o)
                    : this.pushClassProperty(t, n);
                else if (d && "async" === c.name && !this.isLineTerminator()) {
                  var m = this.eat(h.star);
                  (u.kind = "method"),
                    this.parseClassPropertyName(u),
                    "PrivateName" === u.key.type
                      ? this.pushClassPrivateMethod(t, a, m, !0)
                      : (this.isNonstaticConstructor(r) &&
                          this.raise(
                            r.key.start,
                            "Constructor can't be an async function"
                          ),
                        this.pushClassMethod(t, r, m, !0, !1));
                } else
                  !d ||
                  ("get" !== c.name && "set" !== c.name) ||
                  (this.isLineTerminator() && this.match(h.star))
                    ? this.isLineTerminator()
                      ? l
                        ? this.pushClassPrivateProperty(t, o)
                        : this.pushClassProperty(t, n)
                    ...
                    : ((u.kind = c.name),
                      ...
                      "PrivateName" === u.key.type
                        ...
                        : (this.isNonstaticConstructor(r) &&
                          ...
                          this.pushClassMethod(t, r, !1, !1, !1)),
              ...
              (s.pushClassPrivateMethod = function(t, e, s, i) {
                this.expectPlugin("classPrivateMethods", e.key.start),
                  t.body.push(
                    this.parseMethod(e, s, i, !1, "ClassPrivateMethod")
                  );
              }),
              (s.parsePostMemberNameModifiers = function(t) {}),
              (s.parseAccessModifier = function() {}),
              (s.parseClassPrivateProperty = function(t) {
                var e = this.state.inMethod;
                return (
                  (this.state.inMethod = !1),
                  (this.state.inClassProperty = !0),
                  (t.value = this.eat(h.eq) ? this.parseMaybeAssign() : null),
                  this.semicolon(),
                  (this.state.inClassProperty = !1),
                  (this.state.inMethod = e),
              ...
              (s.parseExport = function(t) {
                if (this.shouldParseExportStar()) {
                  if (
                    (this.parseExportStar(t), "ExportAllDeclaration" === t.type)
                  )
                    return t;
                  ...
                  if (
                    ((t.specifiers = s),
                    this.match(h.comma) && this.lookahead().type === h.star)
                  ) {
                    this.expect(h.comma);
                    ...
                    this.expect(h.star),
                      ...
                      s.push(this.finishNode(i, "ExportNamespaceSpecifier"));
              ...
              (s.isAsyncFunction = function() {
                ...
                return !(
                  c.test(e.slice(s, r)) ||
                  "function" !== e.slice(r, r + 8) ||
                  (r + 8 !== e.length && k(e.charAt(r + 8)))
                );
              }),
              (s.parseExportDefaultExpression = function() {
                var t = this.startNode(),
                  e = this.isAsyncFunction();
                if (this.eat(h._function) || e)
                  return (
                    e &&
                      (this.eatContextual("async"), this.expect(h._function)),
                    this.parseFunction(t, !0, !1, e, !0)
                  );
                ...
                if (e)
                  if (s) this.checkDuplicateExports(t, "default");
                    ...
                    if (
                      ...
                      for (
                        var o = 0, h = t.declaration.declarations;
                        o < h.length;
                        o++
                      ) {
                        var u = h[o];
              ...
              (s.parseImportSpecifierLocal = function(t, e, s, i) {
                (e.local = this.parseIdentifier()),
                  this.checkLVal(e.local, !0, void 0, i),
            ...
            (function(t) {
              ...
              return (
                ...
                (s.parseMaybeAssign = function(t, e, s, i) {
                  ...
                  if (
                    (s && (u = s.call(this, u, a, n)), this.state.type.isAssign)
                  ) {
                    var p,
                ...
                (s.parseExprOp = function(t, e, s, i, r) {
                  ...
                  if (!(null == a || (r && this.match(h._in))) && a > i) {
                    ...
                    return (
                      (n.right = this.parseExprOpRightExpr(u, a, r)),
                      this.finishNode(
                        n,
                        u === h.logicalOR ||
                          u === h.logicalAND ||
                ...
                (s.parseSubscript = function(t, e, s, i, r) {
                  ...
                  if (this.match(h.questionDot)) {
                    if (
                      ...
                      i && this.lookahead().type == h.parenL)
                    )
                      return (r.stop = !0), t;
                    this.next();
                    var n = this.startNodeAt(e, s);
                  ...
                  if (this.eat(h.bracketL)) {
                    ...
                    return (
                      ...
                      r.optionalChainMember
                        ? ((p.optional = !1),
                          this.finishNode(p, "OptionalMemberExpression"))
                    ...
                    return (
                      ...
                      d && this.shouldParseAsyncArrow()
                        ? ((r.stop = !0),
                          ...
                          (this.state.yieldOrAwaitInPossibleArrowParameters = l))
                        : (this.toReferencedListDeep(f.arguments),
                          (this.state.yieldOrAwaitInPossibleArrowParameters =
                            this.state.yieldOrAwaitInPossibleArrowParameters ||
                            l)),
                      (this.state.maybeInArrowParameters = c),
                      f
                    );
                  }
                  return this.match(h.backQuote)
                ...
                (s.parseCallExpressionArguments = function(t, e, s) {
                  for (var i, r = [], a = !0; !this.eat(t); ) {
                    ...
                    this.match(h.parenL) && !i && (i = this.state.start),
                      r.push(
                  ...
                  return (
                    e && i && this.shouldParseAsyncArrow() && this.unexpected(),
                    r
                  );
                }),
                ...
                (s.parseAsyncArrowFromCallExpression = function(t, e) {
                  return (
                    this.expect(h.arrow),
                    this.parseArrowExpression(t, e.arguments, !0),
                    t
                  );
                }),
                ...
                (s.parseExprAtom = function(t) {
                  ...
                  switch (this.state.type) {
                    ...
                    case h._import:
                      return this.lookahead().type === h.dot
                        ? this.parseImportMetaProperty()
                        : (this.expectPlugin("dynamicImport"),
                          (e = this.startNode()),
                          this.next(),
                          this.match(h.parenL) ||
                            this.unexpected(null, h.parenL),
                    ...
                    case h.name:
                      ...
                      if ("await" === n.name) {
                        ...
                        if (
                          ...
                          return this.next(), this.parseFunction(e, !1, !1, !0);
                        if (
                          s &&
                          !this.canInsertSemicolon() &&
                          "async" === n.name &&
                          ...
                          var o = this.state
                            ...
                            u = this.state.inAsync;
                          (this.state.yieldOrAwaitInPossibleArrowParameters = null),
                            (this.state.inAsync = !0);
                          var p = [this.parseIdentifier()];
                          return (
                            this.expect(h.arrow),
                            this.parseArrowExpression(e, p, !0),
                            (this.state.yieldOrAwaitInPossibleArrowParameters = o),
                            (this.state.inAsync = u),
                            e
                          );
                        }
                      ...
                      if (
                        ...
                        return (
                          (this.state.yieldOrAwaitInPossibleArrowParameters = null),
                          this.parseArrowExpression(e, [n]),
                          (this.state.yieldOrAwaitInPossibleArrowParameters = c),
                          e
                        );
                      }
                      return n;
                    ...
                    case h.bracketL:
                      return (
                        (e = this.startNode()),
                        this.next(),
                        (e.elements = this.parseExprList(h.bracketR, !0, t)),
                      ...
                      if (this.state.inPipeline) {
                        if (
                          ...
                          return (
                            ...
                            this.finishNode(e, "PipelinePrimaryTopicReference")
                          );
                        throw this.raise(
                          e.start,
                ...
                (s.parseFunctionExpression = function() {
                  ...
                  return (
                    ...
                    this.state.inGenerator && this.eat(h.dot)
                ...
                (s.parseParenAndDistinguishExpression = function(t) {
                  ...
                  for (
                    ...
                    if (this.match(h.ellipsis)) {
                      ...
                      if (
                        ((n = this.state.start),
                        c.push(this.parseParenItem(this.parseRest(), m, y)),
                        this.match(h.comma))
                      ) {
                        var D =
                          this.lookahead().type === h.parenR
                            ? "A trailing comma is not permitted after the rest element"
                    ...
                    c.push(
                      this.parseMaybeAssign(!1, l, this.parseParenItem, d)
                    );
                  }
                  ...
                  if (
                    ...
                    return (
                      this.parseArrowExpression(P, c),
                      (this.state.yieldOrAwaitInPossibleArrowParameters = a),
                      P
                    );
                  }
                  return (
                    (this.state.yieldOrAwaitInPossibleArrowParameters =
                      this.state.yieldOrAwaitInPossibleArrowParameters || a),
                    c.length || this.unexpected(this.state.lastTokStart),
                    o && this.unexpected(o),
                    n && this.unexpected(n),
                    l.start && this.unexpected(l.start),
                    d.start && this.unexpected(d.start),
                    this.toReferencedListDeep(c, !0),
                    c.length > 1
                      ? (((e = this.startNodeAt(u, p)).expressions = c),
                        this.finishNodeAt(e, "SequenceExpression", x, v))
                      : (e = c[0]),
                ...
                (s.parseObj = function(t, e) {
                  ...
                  for (var n = null; !this.eat(h.braceR); ) {
                    ...
                    this.parseObjPropValue(o, c, l, u, p, t, e, f),
                ...
                (s.parseObjectMethod = function(t, e, s, i, r) {
                  return s || e || this.match(h.parenL)
                    ? (i && this.unexpected(),
                      (t.kind = "method"),
                      (t.method = !0),
                ...
                (s.parseMethod = function(t, e, s, i, r) {
                  ...
                  (this.state.inFunction = !0),
                    ...
                    (this.state.inGenerator = e),
                    this.initFunction(t, s),
                    (t.generator = !!e);
                  var u = i;
                  return (
                    this.parseFunctionParams(t, u),
                    this.parseFunctionBodyAndFinish(t, r),
                    (this.state.inFunction = a),
                    (this.state.inMethod = n),
                    (this.state.inAsync = o),
                    (this.state.inGenerator = h),
                    t
                  );
                }),
                (s.parseArrowExpression = function(t, e, s) {
                  ...
                  i &&
                    ("YieldExpression" === i.type
                      ...
                      : this.raise(
                          i.start,
                          "await is not allowed in the parameters of an arrow function inside an async function"
                        ));
                  var r = this.state.inFunction;
                  (this.state.inFunction = !0),
                    this.initFunction(t, s),
                    e && this.setArrowFunctionParameters(t, e);
                ...
                (s.parseFunctionBody = function(t, e) {
                  ...
                  if (((this.state.inParameters = !1), s))
                  ...
                  this.checkFunctionNameAndParams(t, e),
                    (this.state.inParameters = i);
                }),
                  ...
                  if ((s && (this.state.strict = s), i)) {
                    ...
                    for (var n = 0, o = t.params; n < o.length; n++) {
                      ...
                      s &&
                        ...
                        this.checkLVal(h, !0, a, "function parameter list");
                    }
                  }
                  this.state.strict = r;
                }),
                ...
                (s.parseExprListItem = function(t, e, s, i) {
                  ...
                  if (t && this.match(h.comma)) r = null;
                    ...
                    var a = this.state.start,
                      n = this.state.startLoc;
                    (r = this.parseParenItem(this.parseSpread(e, s), a, n)),
                      i && this.match(h.comma) && (i.start = this.state.start);
                  } else
                ...
                (s.parseAwait = function(t) {
                  return (
                    ...
                    this.state.maybeInArrowParameters &&
                      !this.state.yieldOrAwaitInPossibleArrowParameters &&
                      (this.state.yieldOrAwaitInPossibleArrowParameters = t),
              ...
              (function(t) {
                ...
                return (
                  ...
                  (s.parseBindingAtom = function() {
                    switch (this.state.type) {
                      ...
                      case h.bracketL:
                        ...
                        return (
                          this.next(),
                          (t.elements = this.parseBindingList(h.bracketR, !0)),
                  ...
                  (s.parseBindingList = function(t, e, s) {
                    for (var i = [], r = !0; !this.eat(t); )
                      if (
                        (r ? (r = !1) : this.expect(h.comma),
                        e && this.match(h.comma))
                      )
                        i.push(null);
                      else {
                        if (this.eat(t)) break;
                  ...
                  return (
                    ...
                    (s.resetStartLocationFromNode = function(t, e) {
                      (t.start = e.start),
                        ...
                        this.options.ranges && (t.range[0] = e.range[0]);
                    }),
                    e
                  );
                })(z)
        ...
        ht = {
          estree: function(t) {
            return (function(t) {
              ...
              var s = e.prototype;
              return (
                (s.estreeParseRegExpLiteral = function(t) {
                  var e = t.pattern,
                    s = t.flags,
                    i = null;
                  try {
                ...
                (s.initFunction = function(e, s) {
                  t.prototype.initFunction.call(this, e, s),
                    (e.expression = !1);
                }),
                ...
                (s.pushClassMethod = function(t, e, s, i, r) {
                  this.parseMethod(e, s, i, r, "MethodDefinition"),
                    e.typeParameters &&
                ...
                (s.parseFunctionBody = function(e, s) {
                  t.prototype.parseFunctionBody.call(this, e, s),
                ...
                (s.parseMethod = function(e, s, i, r, a) {
                  ...
                  return (
                    (n.kind = e.kind),
                    delete (n = t.prototype.parseMethod.call(
                      this,
                      n,
                      s,
                      i,
                ...
                (s.parseObjectMethod = function(e, s, i, r, a) {
                  var n = t.prototype.parseObjectMethod.call(
                    this,
                    e,
                    s,
                    i,
            ...
            return (function(t) {
              ...
              return (
                ...
                (s.jsxReadEntity = function() {
                  for (
                    var t,
                      ...
                      r = ++this.state.pos;
                    this.state.pos < this.input.length && s++ < 10;
                ...
                (s.jsxParseOpeningElementAfterName = function(t) {
                  for (
                    var e = [];
                    !this.match(h.slash) && !this.match(h.jsxTagEnd);
                    ...
                    t: for (;;)
                      switch (this.state.type) {
                        ...
                        case h.jsxText:
                          ...
                          break;
                        case h.braceL:
                          this.lookahead().type === h.ellipsis
                ...
                (s.parseExprAtom = function(e) {
                  return this.match(h.jsxText)
                    ...
                    : this.isRelational("<") &&
                      33 !== this.state.input.charCodeAt(this.state.pos)
                    ? (this.finishToken(h.jsxTagStart), this.jsxParseElement())
                ...
                (s.readToken = function(e) {
                  ...
                  if (s === D.j_oTag || s === D.j_cTag) {
                    ...
                    if (62 === e)
                      return ++this.state.pos, this.finishToken(h.jsxTagEnd);
                    if ((34 === e || 39 === e) && s === D.j_oTag)
                      return this.jsxReadString(e);
                  }
                  return 60 === e &&
                    this.state.exprAllowed &&
                    33 !== this.state.input.charCodeAt(this.state.pos + 1)
                    ? (++this.state.pos, this.finishToken(h.jsxTagStart))
                ...
                (s.updateContext = function(e) {
                  if (this.match(h.braceL)) {
                    var s = this.curContext();
                    s === D.j_oTag
                      ? this.state.context.push(D.braceExpression)
                      : s === D.j_expr
                      ? this.state.context.push(D.templateQuasi)
                      : t.prototype.updateContext.call(this, e),
                      (this.state.exprAllowed = !0);
                  } else {
                    if (!this.match(h.slash) || e !== h.jsxTagStart)
                      return t.prototype.updateContext.call(this, e);
                    (this.state.context.length -= 2),
                      this.state.context.push(D.j_cTag),
                      (this.state.exprAllowed = !1);
                  }
                }),
                e
          ...
          flow: function(t) {
            return (function(t) {
              function e(e, s) {
                var i;
                return (
                  ((i = t.call(this, e, s) || this).flowPragma = void 0), i
                );
              }
              i(e, t);
              var s = e.prototype;
              return (
                (s.shouldParseTypes = function() {
                  return (
                    ...
                    i.forEach(function(t) {
                      !(function(t) {
                        ...
                        ? "DeclareModuleExports" === t.type &&
                          ...
                          "ES" === n && e.unexpected(t.start, u),
                          (n = "CommonJS"),
                          (o = !0))
                        : ("CommonJS" === n && e.unexpected(t.start, u),
                          (n = "ES"));
                    }),
                    (t.kind = n || "CommonJS"),
                ...
                (s.flowParseDeclareExportDeclaration = function(t, e) {
                  if ((this.expect(h._export), this.eat(h._default)))
                    return (
                      this.match(h._function) || this.match(h._class)
                ...
                (s.checkReservedType = function(t, e) {
                  F.indexOf(t) > -1 &&
                    this.raise(e, "Cannot overwrite reserved type " + t);
                }),
                ...
                (s.flowParseOpaqueType = function(t, e) {
                  return (
                    ...
                    (t.supertype = null),
                    this.match(h.colon) &&
                      (t.supertype = this.flowParseTypeInitialiser(h.colon)),
                    (t.impltype = null),
                    e || (t.impltype = this.flowParseTypeInitialiser(h.eq)),
                    this.semicolon(),
                ...
                (s.flowParseTypeParameter = function(t, e) {
                  ...
                  return (
                    (i.name = a.name),
                    (i.variance = r),
                    (i.bound = a.typeAnnotation),
                    this.match(h.eq)
                      ? t
                        ? (this.eat(h.eq), (i.default = this.flowParseType()))
                        : this.unexpected()
                      : e &&
                        this.unexpected(
                          s,
                ...
                (s.flowParseTypeParameterDeclaration = function(t) {
                  ...
                  (s.params = []),
                    (this.state.inType = !0),
                    this.isRelational("<") || this.match(h.jsxTagStart)
                      ? this.next()
                      : this.unexpected();
                  var i = !1;
                  do {
                    ...
                    s.params.push(r),
                      r.default && (i = !0),
                      this.isRelational(">") || this.expect(h.comma);
                ...
                (s.flowParseObjectTypeMethodish = function(t) {
                  for (
                    ...
                    t.params.push(this.flowParseFunctionTypeParam()),
                      this.match(h.parenR) || this.expect(h.comma);
                  return (
                    this.eat(h.ellipsis) &&
                ...
                (s.flowParseObjectType = function(t) {
                  ...
                  var c = !1;
                  for (
                    s && this.match(h.braceBarL)
                      ? (this.expect(h.braceBarL), (o = h.braceBarR), (u = !0))
                      : (this.expect(h.braceL), (o = h.braceR), (u = !1)),
                      p.exact = u;
                    !this.match(o);
                      ...
                      null != d && this.unexpected(d),
                        this.eat(h.bracketL)
                          ? (D && this.unexpected(D.start),
                            p.internalSlots.push(
                              this.flowParseObjectTypeInternalSlot(f, l)
                            ))
                          : p.indexers.push(
                              this.flowParseObjectTypeIndexer(f, l, D)
                            );
                    else if (this.match(h.parenL) || this.isRelational("<"))
                      null != d && this.unexpected(d),
                        D && this.unexpected(D.start),
                        p.callProperties.push(
                          this.flowParseObjectTypeCallProperty(f, l)
                        );
                    else {
                      var x = "init";
                      if (
                ...
                (s.flowParseFunctionTypeParam = function() {
                  var t = null,
                    ...
                    r = this.lookahead();
                  return (
                    r.type === h.colon || r.type === h.question
                ...
                (s.flowParsePostfixType = function() {
                  for (
                    ...
                    !this.canInsertSemicolon() && this.match(h.bracketL);
                ...
                (s.parseConditional = function(e, s, i, r, a) {
                  ...
                  if (a) {
                    ...
                    try {
                      return t.prototype.parseConditional.call(
                        this,
                        e,
                        s,
                        i,
                  ...
                  if (f || D.length > 0) {
                    ...
                    if (D.length > 0) {
                      ...
                      for (var v = 0; v < D.length; v++) x.push(D[v].start);
                    ...
                    "ArrowFunctionExpression" === n.type
                      ? (n.typeParameters || !n.returnType
                          ? (this.toAssignableList(
                            ...
                            t.prototype.checkFunctionNameAndParams.call(
                              this,
                              n,
                              !0
                            ))
                      ...
                      : "ConditionalExpression" === n.type &&
                        (r.push(n.consequent), r.push(n.alternate));
                  }
                  if (s) {
                ...
                (s.parseParenItem = function(e, s, i) {
                  if (
                    ...
                    this.eat(h.question) && (e.optional = !0),
                    this.match(h.colon))
                  ) {
                    var r = this.startNodeAt(s, i);
                    return (
                ...
                (s.assertModuleNodeAllowed = function(e) {
                  ("ImportDeclaration" === e.type &&
                    ...
                    ("ExportAllDeclaration" === e.type &&
                      "type" === e.exportKind) ||
                    t.prototype.assertModuleNodeAllowed.call(this, e);
                }),
                ...
                (s.parseExportStar = function(e) {
                  return (
                    ...
                    t.prototype.parseExportStar.call(this, e)
                  );
                }),
                (s.parseExportNamespace = function(e) {
                  return (
                    "type" === e.exportKind && this.unexpected(),
                    t.prototype.parseExportNamespace.call(this, e)
                  );
                }),
                (s.parseClassId = function(e, s, i) {
                  t.prototype.parseClassId.call(this, e, s, i),
                    this.isRelational("<") &&
                  ...
                  return !this.state.inType || (62 !== e && 60 !== e)
                    ? (function(t, e) {
                      ...
                      ? ((this.state.isIterator = !0),
                        t.prototype.readWord.call(this))
                      : t.prototype.readToken.call(this, e)
                ...
                (s.parseClassProperty = function(e) {
                  return (
                    this.match(h.colon) &&
                      (e.typeAnnotation = this.flowParseTypeAnnotation()),
                    t.prototype.parseClassProperty.call(this, e)
                  );
                }),
                (s.parseClassPrivateProperty = function(e) {
                  return (
                    this.match(h.colon) &&
                      (e.typeAnnotation = this.flowParseTypeAnnotation()),
                    t.prototype.parseClassPrivateProperty.call(this, e)
                  );
                }),
                (s.isClassMethod = function() {
                  return (
                    this.isRelational("<") ||
                    t.prototype.isClassMethod.call(this)
                  );
                }),
                (s.isClassProperty = function() {
                  return (
                    this.match(h.colon) ||
                    t.prototype.isClassProperty.call(this)
                  );
                }),
                ...
                (s.pushClassMethod = function(e, s, i, r, a) {
                  s.variance && this.unexpected(s.variance.start),
                    ...
                    t.prototype.pushClassMethod.call(this, e, s, i, r, a);
                }),
                (s.pushClassPrivateMethod = function(e, s, i, r) {
                  s.variance && this.unexpected(s.variance.start),
                    ...
                    this.isRelational("<") &&
                      (s.typeParameters = this.flowParseTypeParameterDeclaration()),
                    t.prototype.pushClassPrivateMethod.call(this, e, s, i, r);
                }),
                ...
                (s.parseObjPropValue = function(e, s, i, r, a, n, o, u) {
                  ...
                  e.variance && this.unexpected(e.variance.start),
                    delete e.variance,
                    this.isRelational("<") &&
                      ((p = this.flowParseTypeParameterDeclaration(!1)),
                ...
                (s.shouldParseDefaultImport = function(e) {
                  return S(e)
                    ? I(this.state)
                    : t.prototype.shouldParseDefaultImport.call(this, e);
                }),
                (s.parseImportSpecifierLocal = function(t, e, s, i) {
                  (e.local = S(t)
                ...
                (s.parseImportSpecifiers = function(e) {
                  ...
                  if (
                    ...
                    "type" === s &&
                      ...
                      (I(i) || i.type === h.braceL || i.type === h.star) &&
                ...
                (s.parseImportSpecifier = function(t) {
                  ...
                  if (
                    ...
                    null === r || this.match(h.name) || this.state.type.keyword
                      ? ((e.imported = i),
                        (e.importKind = null),
                        (e.local = this.parseIdentifier()))
                      : ((e.imported = n),
                ...
                (s.parseFunctionParams = function(e) {
                  ...
                  "get" !== s &&
                    ...
                    t.prototype.parseFunctionParams.call(this, e);
                }),
                ...
                (s.parseMaybeAssign = function(e, s, i, r) {
                  ...
                  if (
                    this.hasPlugin("jsx") &&
                    (this.match(h.jsxTagStart) || this.isRelational("<"))
                  ) {
                    var o = this.state.clone();
                    try {
                      return t.prototype.parseMaybeAssign.call(
                        this,
                        e,
                        s,
                        i,
                      ...
                      this.state.context[u - 1] === D.j_oTag &&
                        (this.state.context.length -= 2),
                        (n = t);
                    }
                  }
                  if (null != n || this.isRelational("<")) {
                    ...
                    try {
                      (c = this.flowParseTypeParameterDeclaration()),
                        ((p = this.forwardNoArrowParamsConversionAt(
                          c,
                          function() {
                            return t.prototype.parseMaybeAssign.call(
                              a,
                        ...
                        this.resetStartLocationFromNode(p, c);
                    } catch (t) {
                      throw n || t;
                    }
                  ...
                  if (this.match(h.colon)) {
                    ...
                    try {
                      ...
                      (r.typeAnnotation = a[0]),
                        ...
                        this.match(h.arrow) || this.unexpected(),
                        (e.returnType = r.typeAnnotation
                          ? this.finishNode(r, "TypeAnnotation")
                          : null);
                    } catch (t) {
                ...
                (s.checkFunctionNameAndParams = function(e, s) {
                  if (
                    ...
                    return t.prototype.checkFunctionNameAndParams.call(
                      this,
                      e,
                      s
                    );
                ...
                (s.parseParenAndDistinguishExpression = function(e) {
                  return t.prototype.parseParenAndDistinguishExpression.call(
                    this,
                ...
                (s.parseSubscript = function(e, s, i, r, a) {
                  ...
                  if (!r && this.shouldParseTypes() && this.isRelational("<")) {
                    ...
                    try {
                      return (
                        (o.typeArguments = this.flowParseTypeParameterInstantiationCallOrNew()),
                        this.expect(h.parenL),
                ...
                (s.readToken_mult_modulo = function(e) {
                  var s = this.input.charCodeAt(this.state.pos + 1);
                  if (42 === e && 47 === s && this.state.hasFlowComment)
                    return (
                ...
                (s.skipBlockComment = function() {
                  return this.hasPlugin("flow") &&
                    ...
                    : void t.prototype.skipBlockComment.call(this);
                  var e;
                }),
            ...
            return (function(t) {
              ...
              return (
                ...
                (s.tsParseBracketedList = function(t, e, s, i) {
                  i ||
                    (s ? this.expect(h.bracketL) : this.expectRelational("<"));
                  var r = this.tsParseDelimitedList(t, e);
                  return (
                    s ? this.expect(h.bracketR) : this.expectRelational(">"), r
                  );
                }),
                ...
                (s.tsParseTypeParameter = function() {
                  ...
                  return (
                    ...
                    (t.constraint = this.tsEatThenParseType(h._extends)),
                ...
                (s.tsParsePropertyOrMethodSignature = function(t, e) {
                  ...
                  var a = s;
                  return (
                    this.tsFillSignature(h.colon, a),
                    this.tsParseTypeMemberSemicolon(),
                ...
                (s.tsIsStartOfConstructSignature = function() {
                  return (
                    this.next(), this.match(h.parenL) || this.isRelational("<")
                  );
                }),
                ...
                (s.tsParseMappedTypeParameter = function() {
                  ...
                  return (
                    (t.name = this.parseIdentifierName(t.start)),
                    (t.constraint = this.tsExpectThenParseType(h._in)),
                    this.finishNode(t, "TSTypeParameter")
                  );
                }),
                ...
                (s.tsParseTupleType = function() {
                  ...
                  var s = !1;
                  return (
                    e.elementTypes.forEach(function(i, r) {
                      "TSRestType" === i.type
                        ? r !== e.elementTypes.length - 1 &&
                          t.raise(
                            i.start,
                            "A rest element must be last in a tuple type."
                          )
                        : "TSOptionalType" === i.type
                        ? (s = !0)
                        : s &&
                          t.raise(
                            i.start,
                ...
                (s.tsParseFunctionOrConstructorType = function(t) {
                  var e = this.startNode();
                  return (
                    "TSConstructorType" === t && this.expect(h._new),
                ...
                (s.tsParseArrayTypeOrHigher = function() {
                  for (
                    ...
                    !this.hasPrecedingLineBreak() && this.eat(h.bracketL);
                ...
                (s.tsSkipParameterStart = function() {
                  ...
                  if (this.match(h.braceL)) {
                    var t = 1;
                    for (this.next(); t > 0; )
                      this.match(h.braceL) ? ++t : this.match(h.braceR) && --t,
                        this.next();
                    return !0;
                  }
                  return !1;
                ...
                (s.tsParseTypeOrTypePredicateAnnotation = function(t) {
                  ...
                  return this.tsInType(function() {
                    ...
                    return (
                      (a.parameterName = i),
                      (a.typeAnnotation = r),
                      (s.typeAnnotation = e.finishNode(a, "TSTypePredicate")),
                ...
                (s.tsTryParseTypeOrTypePredicateAnnotation = function() {
                  return this.match(h.colon)
                    ? this.tsParseTypeOrTypePredicateAnnotation(h.colon)
                    : void 0;
                }),
                ...
                (s.tsParseTypeAnnotation = function(t, e) {
                  ...
                  return (
                    ...
                    this.tsInType(function() {
                      t && s.expect(h.colon),
                        (e.typeAnnotation = s.tsParseType());
                    }),
                ...
                (s.tsParseType = function() {
                  ...
                  if (this.hasPrecedingLineBreak() || !this.eat(h._extends))
                    return t;
                  var e = this.startNodeAtNode(t);
                  return (
                    (e.checkType = t),
                ...
                (s.tsParseTypeAliasDeclaration = function(t) {
                  return (
                    (t.id = this.parseIdentifier()),
                    (t.typeParameters = this.tsTryParseTypeParameters()),
                    (t.typeAnnotation = this.tsExpectThenParseType(h.eq)),
                    this.semicolon(),
                ...
                (s.tsParseEnumMember = function() {
                  ...
                  return (
                    (t.id = this.match(h.string)
                      ...
                      : this.parseIdentifier(!0)),
                    this.eat(h.eq) && (t.initializer = this.parseMaybeAssign()),
                ...
                (s.tsParseExternalModuleReference = function() {
                  ...
                  if (
                    ...
                    throw this.unexpected();
                  return (
                    (t.expression = this.parseLiteral(
                      this.state.value,
                      "StringLiteral"
                    )),
                    this.expect(h.parenR),
                ...
                (s.nodeWithSamePosition = function(t, e) {
                  ...
                  return (
                    ...
                    (s.loc.end = t.loc.end),
                    t.leadingComments &&
                      (s.leadingComments = t.leadingComments),
                    t.trailingComments &&
                      (s.trailingComments = t.trailingComments),
                    t.innerComments && (s.innerComments = t.innerComments),
                    s
                  );
                }),
                ...
                (s.tsParseDeclaration = function(t, e, s) {
                  switch (e) {
                    case "abstract":
                      ...
                      break;
                    case "enum":
                      if (s || this.match(h.name))
                        return (
                          s && this.next(), this.tsParseEnumDeclaration(t, !1)
                        );
                      break;
                    case "interface":
                      if (s || this.match(h.name))
                      ...
                      break;
                    case "module":
                      if ((s && this.next(), this.match(h.string)))
                ...
                (s.tsTryParseGenericAsyncArrowFunction = function(e, s) {
                  var i = this,
                    r = this.tsTryParseAndCatch(function() {
                      ...
                      return (
                        (r.typeParameters = i.tsParseTypeParameters()),
                        t.prototype.parseFunctionParams.call(i, r),
                        (r.returnType = i.tsTryParseTypeOrTypePredicateAnnotation()),
                        i.expect(h.arrow),
                        r
                      );
                    });
                ...
                (s.parseAssignableListItem = function(t, e) {
                  ...
                  if (s || i) {
                    ...
                    return (
                      (n.parameter = a),
                      this.finishNode(n, "TSParameterProperty")
                    );
                  }
                ...
                (s.parseFunctionBodyAndFinish = function(e, s, i) {
                  ...
                  var r =
                    "FunctionDeclaration" === s
                      ...
                      ? "TSDeclareMethod"
                      : void 0;
                  r && !this.match(h.braceL) && this.isLineTerminator()
                    ? this.finishNode(e, r)
                    : t.prototype.parseFunctionBodyAndFinish.call(
                        this,
                        e,
                        s,
                        i
                  ...
                  if (this.isRelational("<")) {
                    var u = this.tsTryParseAndCatch(function() {
                      ...
                      if (u) {
                        if (!r && n.eat(h.parenL))
                          return (
                            (o.arguments = n.parseCallExpressionArguments(
                              h.parenR,
                              !1
                            )),
                            (o.typeParameters = u),
                            n.finishCallExpression(o)
                          );
                        if (n.match(h.backQuote))
                          return n.parseTaggedTemplateExpression(s, i, e, a, u);
                      }
                      n.unexpected();
                    });
                    if (u) return u;
                ...
                (s.parseExprOp = function(e, s, i, r, a) {
                  if (
                    ...
                    return (
                      (n.expression = e),
                      (n.typeAnnotation = this.tsNextThenParseType()),
                ...
                (s.checkReservedWord = function(t, e, s, i) {}),
                (s.checkDuplicateExports = function() {}),
                (s.parseImport = function(e) {
                  return this.match(h.name) && this.lookahead().type === h.eq
                ...
                (s.parseClassMember = function(e, s, i) {
                  ...
                  r && (s.accessibility = r),
                    t.prototype.parseClassMember.call(this, e, s, i);
                }),
                (s.parseClassMemberWithIsStatic = function(e, s, i, r) {
                  ...
                  t.prototype.parseClassMemberWithIsStatic.call(
                    this,
                    e,
                    s,
                    i,
                ...
                (s.parseConditional = function(e, s, i, r, a) {
                  ...
                  try {
                    ...
                    if (!(t instanceof SyntaxError)) throw t;
                    return (
                      (this.state = n), (a.start = t.pos || this.state.start), e
                    );
                  }
                }),
                (s.parseParenItem = function(e, s, i) {
                ...
                (s.parseExportDeclaration = function(e) {
                  ...
                  return (
                    ...
                    s || (s = t.prototype.parseExportDeclaration.call(this, e)),
                    s && i && (s.declare = !0),
                    s
                  );
                }),
                ...
                (s.parseFunctionParams = function(e, s) {
                  ...
                  i && (e.typeParameters = i),
                    t.prototype.parseFunctionParams.call(this, e, s);
                }),
                (s.parseVarHead = function(e) {
                  t.prototype.parseVarHead.call(this, e),
                ...
                (s.parseAsyncArrowFromCallExpression = function(e, s) {
                  return (
                    ...
                    t.prototype.parseAsyncArrowFromCallExpression.call(
                      this,
                      e,
                      s
                    )
                ...
                (s.parseMaybeAssign = function() {
                  ...
                  if (this.match(h.jsxTagStart)) {
                    ...
                    try {
                      var p;
                      return (p = t.prototype.parseMaybeAssign).call.apply(
                        p,
                        [this].concat(n)
                      );
                    } catch (t) {
                      ...
                      (this.state = u),
                        it(this.curContext() === D.j_oTag),
                        this.state.context.pop(),
                        it(this.curContext() === D.j_expr),
                        this.state.context.pop(),
                        (e = t);
                    }
                  }
                  if (void 0 === e && !this.isRelational("<"))
                    return (s = t.prototype.parseMaybeAssign).call.apply(
                      s,
                      [this].concat(n)
                    );
                  ...
                  try {
                    ...
                    (r = this.tsParseTypeParameters()),
                      "ArrowFunctionExpression" !==
                        (i = (l = t.prototype.parseMaybeAssign).call.apply(
                          l,
                          [this].concat(n)
                    ...
                    return (
                      ...
                      (this.state = c),
                      (d = t.prototype.parseMaybeAssign).call.apply(
                        d,
                        [this].concat(n)
                      )
                    );
                  ...
                  return (
                    r &&
                      0 !== r.params.length &&
                      this.resetStartLocationFromNode(i, r.params[0]),
                    (i.typeParameters = r),
                    i
                  );
                }),
                ...
                (s.parseArrow = function(e) {
                  if (this.match(h.colon)) {
                    var s = this.state.clone();
                    try {
                      var i = this.tsParseTypeOrTypePredicateAnnotation(
                        h.colon
                      );
                      this.canInsertSemicolon() && this.unexpected(),
                        this.match(h.arrow) || this.unexpected(),
                ...
                (s.parseAssignableListItemTypes = function(t) {
                  ...
                  return (
                    e && (t.typeAnnotation = e), this.finishNode(t, t.type)
                  );
                }),
                (s.toAssignable = function(e, s, i) {
                  switch (e.type) {
                    ...
                    case "TSTypeAssertion":
                      return (
                        (e.expression = this.toAssignable(e.expression, s, i)),
                        e
                      );
                    default:
                      return t.prototype.toAssignable.call(this, e, s, i);
                ...
                (s.parseMaybeDecoratorArguments = function(e) {
                  if (this.isRelational("<")) {
                    ...
                    if (this.match(h.parenL)) {
                      var i = t.prototype.parseMaybeDecoratorArguments.call(
                        this,
                        e
                      );
                ...
                (s.canHaveLeadingDecorator = function() {
                  return (
                    t.prototype.canHaveLeadingDecorator.call(this) ||
                ...
                (s.jsxParseOpeningElementAfterName = function(e) {
                  ...
                  return (
                    i && (e.typeParameters = i),
                    t.prototype.jsxParseOpeningElementAfterName.call(this, e)
                  );
                }),
                e
              );
        ...
        return (
          t &&
            ...
            (!(function(t) {
              ...
              if (rt(t, "flow") && rt(t, "typescript"))
                throw new Error("Cannot combine flow and typescript plugins.");
              if (
                rt(t, "pipelineOperator") &&
                -1 === nt.indexOf(at(t, "pipelineOperator", "proposal"))
              )
                throw new Error(
  ...
  function X(e, s) {
    return function(i, r, a) {
      var n,
        o = W,
        h = [
          G({ strictMode: !0 }, ["decorators-legacy"].concat(s)),
          G({ strictMode: !1 }, ["decorators-legacy"].concat(s)),
          G(
            { strictMode: !0 },
      ...
      return delete n.tokens, V(n, Object.assign({}, a, { originalText: i }));
    };
  }
  var J = X("parse", ["flow"]),
    H = X("parse", [["flow", { all: !0 }]]),
    z = X("parseExpression");
  function Q(e, s) {
    switch (e.type) {
      case "ArrayExpression":
  ...
  var $ = Object.assign({ parse: J, astFormat: "estree", hasPragma: K }, p),
    Y = Object.assign({}, $, { parse: H }),
    Z = Object.assign({}, $, { parse: z });
  return {
    parsers: {
      babel: $,
      "babel-flow": Y,
