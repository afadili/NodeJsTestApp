!(function(t, e) {
  ...
  function p(t, e, r) {
    return { type: t, value: e, original: e, loc: v(r || null) };
  }
  function f(t, e) {
    return { type: "Hash", pairs: t || [], loc: v(e || null) };
  }
  function d(t) {
    return t || null;
  }
  ...
  function v() {
    ...
    var i = r[0],
      ...
      o = r[2],
      l = r[3];
    return { source: d(r[4]), start: m(i, s), end: m(o, l) };
  }
  function b(t) {
  ...
  var y = {
    ...
    comment: function(t, e) {
      return { type: "CommentStatement", value: t, loc: v(e || null) };
    },
    mustacheComment: function(t, e) {
      return { type: "MustacheCommentStatement", value: t, loc: v(e || null) };
    },
    element: function(t, r, a, n, i, s, o) {
      Array.isArray(i)
        ? "string" === i[0]
          ? ((s = i), (i = []))
          : b(s) && ((o = s), (s = []))
      ...
      var l = !1;
      return (
        "object" === e(t) && ((l = t.selfClosing), (t = t.name)),
        {
          type: "ElementNode",
          tag: t || "",
          selfClosing: l,
    ...
    attr: function(t, e, r) {
      return { type: "AttrNode", name: t, value: e, loc: v(r || null) };
    },
    text: function(t, e) {
      return { type: "TextNode", chars: t || "", loc: v(e || null) };
    },
    ...
    path: h,
    concat: function(t, e) {
      return { type: "ConcatStatement", parts: t || [], loc: v(e || null) };
    },
    hash: f,
    pair: function(t, e, r) {
      return { type: "HashPair", key: t, value: e, loc: v(r || null) };
    },
    literal: p,
  ...
  function x(t) {
    var e = (function(t) {
      ...
      if (-1 !== n && e > n && "|" === r[n + 1].charAt(0)) {
        ...
        if (0 === s.length)
          throw new S("Cannot use zero block parameters: '" + i + "'", t.loc);
  ...
  function V(t) {
    for (var r = 1; r < arguments.length; r++) {
      ...
      if (null !== a && "object" === e(a))
        for (var n = R(a), i = 0; i < n.length; i++) {
          var s = n[i];
          t[s] = a[s];
        }
    }
  ...
  var H = new T({
    ...
    j = (function(t) {
      function e() {
        ...
        return (
          r(this, e),
          ((t = l(this, s(e).apply(this, arguments))).cursorCount = 0),
          t
        );
      }
      return (
          ...
          },
          {
            ...
            value: function(t) {
              ...
              var e,
                ...
                a = t.body.length;
              if ((this.elementStack.push(r), 0 === a))
                ...
                "in-element" === r.original &&
                  (n = (function(t, e, r) {
                    ...
                    e.pairs.forEach(function(t) {
                      if ("guid" === t.key)
                        throw new S("Cannot pass `guid` from user space", r);
  ...
  function X(t, e) {
    ...
    if (
      (void 0 !== i && ((r = Y(i)), (a = Z(i))),
      void 0 !== r && (n = r(e)),
      void 0 !== n && null !== n)
    ) {
      if (JSON.stringify(e) !== JSON.stringify(n))
        return Array.isArray(n) ? (et(t, n), n) : X(t, n) || n;
      n = void 0;
    }
    if (void 0 === n) {
      for (var s = G[e.type], o = 0; o < s.length; o++) tt(t, i, e, s[o]);
      void 0 !== a && (n = a(e));
    }
    return n;
  }
      ...
      if (Array.isArray(n)) et(t, n);
        ...
        void 0 !== l &&
          (function(t, e, r) {
            ...
            if (Array.isArray(r)) {
              if (1 !== r.length)
                throw 0 === r.length ? J(t[e], t, e) : Q(t[e], t, e);
              t[e] = r[0];
            } else t[e] = r;
          })(r, a, l);
      }
  ...
  function ht(t) {
    ...
    switch (t.type) {
      ...
      case "ElementNode":
        a.push("<", t.tag),
          t.attributes.length && a.push(" ", pt(t.attributes).join(" ")),
          t.modifiers.length && a.push(" ", pt(t.modifiers).join(" ")),
          t.comments.length && a.push(" ", pt(t.comments).join(" ")),
          t.blockParams.length &&
            a.push(" ", "as", " ", "|".concat(t.blockParams.join(" "), "|")),
          re[t.tag]
            ? (t.selfClosing && a.push(" /"), a.push(">"))
            : (a.push(">"),
              a.push.apply(a, pt(t.children)),
              a.push("</", t.tag, ">"));
        break;
      case "AttrNode":
        "TextNode" === t.value.type
          ? "" !== t.value.chars
            ? (a.push(t.name, "="), a.push('"', ut(t.value.chars), '"'))
            : a.push(t.name)
          : (a.push(t.name, "="), a.push(ht(t.value)));
        break;
      ...
      case "BlockStatement":
        ...
        t.chained
          ...
          s.push(ht(t.program)),
          t.inverse &&
            (t.inverse.chained || s.push("{{else}}"), s.push(ht(t.inverse))),
          t.chained ||
            s.push(
              (function(t) {
  ...
  var St = yt(function(t, e) {
    ...
    function a(t, e) {
      ...
      for (
        var o = Error.prototype.constructor.call(this, t), l = 0;
        l < r.length;
        l++
      )
        this[r[l]] = o[r[l]];
      ...
      (e.default = function(t) {
        t.registerHelper("blockHelperMissing", function(e, r) {
          ...
          if (r.data && r.ids) {
            ...
            (i.contextPath = kt.appendContextPath(r.data.contextPath, r.name)),
              (r = { data: i });
          }
          return n(e, r);
        });
  ...
  var xt = yt(function(t, r) {
    r.__esModule = !0;
    var a,
      n = (a = St) && a.__esModule ? a : { default: a };
    (r.default = function(t) {
      t.registerHelper("each", function(t, r) {
        ...
        if (
          (r.data &&
            r.ids &&
            (c = kt.appendContextPath(r.data.contextPath, r.ids[0]) + "."),
          kt.isFunction(t) && (t = t.call(this)),
          r.data && (l = kt.createFrame(r.data)),
          t && "object" === e(t))
        )
          if (kt.isArray(t))
            for (var h = t.length; s < h; s++)
              s in t && u(s, s, s === t.length - 1);
          else {
            var p = void 0;
            for (var f in t)
              t.hasOwnProperty(f) &&
                (void 0 !== p && u(p, s - 1), (p = f), s++);
            void 0 !== p && u(p, s - 1, !0);
          }
    ...
    (e.__esModule = !0),
      (e.default = function(t) {
        t.registerHelper("if", function(t, e) {
          return (
            kt.isFunction(t) && (t = t.call(this)),
            (!e.hash.includeZero && !t) || kt.isEmpty(t)
              ? e.inverse(this)
              : e.fn(this)
          );
        }),
      ...
      (e.default = function(t) {
        t.registerHelper("with", function(t, e) {
          ...
          return (
            e.data &&
              e.ids &&
              ((a = kt.createFrame(e.data)).contextPath = kt.appendContextPath(
                e.data.contextPath,
                e.ids[0]
              )),
            r(t, {
  ...
  var Ct = yt(function(t, e) {
    ...
    var r,
      a = (r = Tt) && r.__esModule ? r : { default: r };
  });
  bt(Ct);
  ...
  var qt = yt(function(t, e) {
    ...
    function i(t, e, r) {
      (this.helpers = t || {}),
        (this.partials = e || {}),
        (this.decorators = r || {}),
        Lt.registerDefaultHelpers(this),
        Ct.registerDefaultDecorators(this);
    }
    i.prototype = {
      constructor: i,
      logger: n.default,
  ...
  var Bt = yt(function(t, r) {
    (r.__esModule = !0),
      ...
      (r.template = function(t, r) {
        ...
        if (!t || !t.main)
          throw new i.default("Unknown template object: " + e(t));
        ...
        return (
          ...
          (o._setup = function(e) {
            e.partial
              ? ((a.helpers = e.helpers),
                (a.partials = e.partials),
                (a.decorators = e.decorators))
    ...
    var a,
      ...
      i = (a = St) && a.__esModule ? a : { default: a };
          ...
          performAction: function(t, e, r, a, n, i, s) {
            ...
            switch (n) {
              ...
              case 19:
                ...
                (c.chained = !0),
                  (this.$ = { strip: i[o - 2].strip, program: c, chain: !0 });
                break;
              case 20:
                this.$ = i[o];
                break;
    ...
    (s.prototype = {
      nameLookup: function(t, e) {
        return "constructor" === e
          ...
          : s.isValidJavaScriptVariableName(e)
          ? [t, ".", e]
          : [t, "[", JSON.stringify(e), "]"];
      },
      ...
      compileChildren: function(t, e) {
        for (
          var r = t.children, a = void 0, n = void 0, i = 0, s = r.length;
          i < s;
          i++
        ) {
  ...
  "undefined" != typeof require &&
    require.extensions &&
    ((require.extensions[".handlebars"] = te),
    (require.extensions[".hbs"] = te));
  var ee = Xt.parse,
    ...
    return (
      ...
      n(e, [
        ...
        },
        {
          key: "finishComment",
          value: function() {
            (this.currentComment.loc.end = y.pos(
              this.tokenizer.line,
        ...
        },
        {
          key: "finishData",
          value: function() {
            (this.currentData.loc.end = y.pos(
              this.tokenizer.line,
              this.tokenizer.column
            )),
        ...
        },
        {
          ...
          value: function() {
            ...
            (a.loc = y.loc(this.tagOpenLine, this.tagOpenColumn, e, r)),
              "StartTag" === a.type
                ? (this.finishStartTag(),
                  (re[a.name] || a.selfClosing) && this.finishEndTag(!0))
        ...
        },
        {
          ...
          value: function() {
            var t = this.currentStartTag,
              ...
              o = y.element({ name: e, selfClosing: i }, r, a, [], n, [], s);
          ...
          value: function(t) {
            ...
            !(function(t, e, r) {
              ...
              re[t.name] && !r
                ...
                : void 0 === e.tag
                ? (a = "Closing tag " + ne(t) + " without an open tag.")
                : e.tag !== t.name &&
                  (a =
                    "Closing tag " +
                    ne(t) +
  ...
  var ie = { parse: se, builders: y, print: ht, traverse: at, Walker: mt };
  function se(t, r) {
    var a = r ? r.parseOptions : {},
      n = "object" === e(t) ? t : ee(t, a),
      i = new ae(t).acceptNode(n);
    if (r && r.plugins && r.plugins.ast)
      for (var s = 0, o = r.plugins.ast.length; s < o; s++) {
        at(
          i,
          (0, r.plugins.ast[s])(V({}, r, { syntax: ie }, { plugins: void 0 }))
            .visitor
        );
      }
    return i;
  ...
  return {
    parsers: {
      glimmer: {
        parse: function(e) {
          try {
            return (0, le.preprocess)(e, { plugins: { ast: [ue] } });
          } catch (e) {
            var r = e.message.match(/on line (\d+)/);
            throw r
              ? t(e.message, { start: { line: Number(r[1]), column: 0 } })
              : e;
          }
        },
        astFormat: "glimmer",
