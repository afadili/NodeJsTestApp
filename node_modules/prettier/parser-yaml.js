!(function(e, t) {
        ...
        function u(e, t) {
          try {
            (n = a[e](t)).value instanceof b
              ? Promise.resolve(n.value.v).then(s, f)
              : c(o[0][2], n);
          } catch (e) {
            c(o[0][3], e);
          }
  ...
  var S = r(function(e, t) {
    ...
    var a = (function(e) {
      function t(e, n) {
        var a;
        if ((o(this, t), !(n && e instanceof r.default)))
          throw new Error("Invalid arguments for new YAMLReferenceError");
        return (
          ((a = p(this, f(t).call(this))).name = "YAMLReferenceError"),
          (a.message = n),
          (a.source = e),
          a
        );
    ...
    var i = (function(e) {
      function t(e, n) {
        ...
        return (
          ((a = p(this, f(t).call(this))).name = "YAMLSemanticError"),
          (a.message = n),
          (a.source = e),
          a
        );
    ...
    var u = (function(e) {
      function t(e, n) {
        ...
        return (
          ((a = p(this, f(t).call(this))).name = "YAMLSyntaxError"),
          (a.message = n),
          (a.source = e),
          a
        );
    ...
    var c = (function(e) {
      function t(e, n) {
        ...
        return (
          ((a = p(this, f(t).call(this))).name = "YAMLWarning"),
          (a.message = n),
          (a.source = e),
          a
        );
  ...
  var A = r(function(e, t) {
    ...
    var n,
      ...
      a = (n = E) && n.__esModule ? n : { default: n };
    var i = (function(e) {
      function t() {
  ...
  var P = r(function(e, t) {
    ...
    var i = (function(e) {
      function t() {
        ...
        return (
          o(this, t),
          ((e = p(this, f(t).call(this, r.Type.DIRECTIVE))).name = null),
          e
        );
      }
      return (
  ...
  var T = r(function(e, t) {
    ...
    var l = (function(e) {
      function t() {
        ...
        return (
          o(this, t),
          ((e = p(this, f(t).call(this, a.Type.DOCUMENT))).directives = null),
          (e.contents = null),
          e
        );
      }
        ...
        u(t, [
          {
            ...
            value: function(e) {
              ...
              for (
                var i = !1, u = e;
                !a.default.atDocumentBoundary(o, u, a.Char.DIRECTIVES_END);

              )
                switch (o[(u = t.startCommentOrEndBlankLine(o, u))]) {
                  case "\n":
                    u += 1;
                    break;
                  case "#":
                    var s = new n.default();
                    (u = s.parse({ src: o }, u)), this.directives.push(s);
                    break;
                  case "%":
                    var f = new r.default();
                    (u = f.parse({ parent: this, src: o }, u)),
                  ...
                  default:
                    return (
                      i
                        ? (this.error = new S.YAMLSemanticError(
                            this,
          ...
          },
          {
            ...
            value: function(e) {
              ...
              var f = a.default.endOfWhiteSpace(u, e),
                c = s === e;
              for (
                this.valueRange = new i.default(f);
                !a.default.atDocumentBoundary(u, f, a.Char.DOCUMENT_END);
                ...
                switch (u[f]) {
                  ...
                  case "#":
                    var l = new n.default();
                    (f = l.parse({ src: u }, f)), this.contents.push(l);
                    break;
                  default:
              ...
              if (((this.valueRange.end = f), u[f] && u[(f += 3)])) {
                if ("#" === u[(f = a.default.endOfWhiteSpace(u, f))]) {
                  var p = new n.default();
                  (f = p.parse({ src: u }, f)), this.contents.push(p);
                }
                switch (u[f]) {
                  case "\n":
                    f += 1;
                  ...
                  case void 0:
                    break;
                  default:
                    this.error = new S.YAMLSyntaxError(
                      this,
          ...
          },
          {
            ...
            value: function(e, n) {
              return (
                (n = v(f(t.prototype), "setOrigRanges", this).call(this, e, n)),
          ...
          },
          {
            ...
            value: function() {
              ...
              return (
                e.length > 0 &&
                  ((t.length > 0 || e[0].type === a.Type.COMMENT) &&
                    (r += "---\n"),
                  (r += e.join(""))),
                "\n" !== r[r.length - 1] && (r += "\n"),
                r
  ...
  var k = r(function(e, t) {
    ...
    var n,
      ...
      a = (n = E) && n.__esModule ? n : { default: n };
    var i = { CLIP: "CLIP", KEEP: "KEEP", STRIP: "STRIP" };
    t.Chomp = i;
    var c = (function(e) {
      function t(e, n) {
        var r;
        return (
          o(this, t),
          ((r = p(this, f(t).call(this, e, n))).blockIndent = null),
          (r.chomping = i.CLIP),
          (r.header = null),
          r
        );
        ...
        u(t, [
            ...
            value: function(e) {
              for (
                var t = this.context,
                  ...
                  s = 1,
                  f = o[i];
                "\n" === f && ((i += 1), !r.default.atDocumentBoundary(o, i));
                f = o[i]
              ) {
          ...
          },
          {
            ...
            value: function(e, t) {
              ...
              return (
                (a = r.default.endOfWhiteSpace(n, a)),
          ...
          },
          {
            ...
            get: function() {
              ...
              s &&
                (this.chomping === i.KEEP
                  ? ((c = s), (n = this.valueRange.end))
                  : (n = s));
              for (
                var l = o + this.blockIndent,
                  d = this.type === r.Type.BLOCK_FOLDED,
                  h = !0,
                  p = "",
                  v = "",
                  g = !1,
  ...
  var x = r(function(e, t) {
    ...
    var i = (function(e) {
      function t(e, n) {
        var r;
        return (
          o(this, t), ((r = p(this, f(t).call(this, e, n))).node = null), r
        );
      }
      return (
        s(t, r.default),
        u(t, [
          {
            ...
            value: function(e, t) {
              ...
              for (
                var s = i ? t - u : e.indent,
                  f = r.default.endOfWhiteSpace(o, t + 1),
                  c = o[f];
                "\n" === c || "#" === c;
              ...
              r.default.nextNodeIsIndented(
                ...
                ? ((this.node = n(
                  ...
                  this.node && (f = this.node.range.end))
                : c && u > t + 1 && (f = u - 1);
      ...
      function t(e) {
        ...
        o(this, t),
          ((n = p(
            ...
            f(t).call(
              this,
              e.type === r.Type.SEQ_ITEM ? r.Type.SEQ : r.Type.MAP
            )
          )).items = [e]);
        for (var a = e.props.length - 1; a >= 0; --a)
          if (e.props[a].start < e.context.lineStart) {
            (n.props = e.props.slice(0, a + 1)),
        ...
        u(t, [
          {
            ...
            value: function(e, t) {
              ...
              var o = e.parseNode,
                ...
                s = this.items[0];
              (s.context.parent = this),
                (this.valueRange = a.default.copy(s.valueRange));
              for (
                var f = s.range.start - s.context.lineStart,
                  c = t,
                  l = i[(c = r.default.normalizeOffset(i, c))],
                  d = r.default.endOfWhiteSpace(i, u) === c;
                l;
                ...
                for (; "\n" === l || "#" === l; ) {
                  ...
                  if (
                    ((u = c + 1),
                    (c = r.default.endOfIndent(i, u)),
                    r.default.atBlank(i, c))
                  ) {
                ...
                if (
                  (this.items.push(y),
                  (this.valueRange.end = y.valueRange.end),
                  (d = !1),
                  (l = i[(c = r.default.normalizeOffset(i, y.range.end))]) &&
                    "\n" !== l &&
                    "#" !== l)
                ) {
                  for (var _ = c - 1, b = i[_]; " " === b || "\t" === b; )
                    b = i[--_];
                  "\n" === b && ((u = _ + 1), (d = !0));
                }
              }
          ...
          },
          {
            ...
            value: function() {
              ...
              if (null != a) return a;
              for (
                var o = e.slice(n.start, t[0].range.start) + String(t[0]),
                  i = 1;
                i < t.length;
                ++i
              ) {
  ...
  var R = r(function(e, t) {
    ...
    var c = (function(e) {
      function t(e, n) {
        var r;
        return (
          o(this, t), ((r = p(this, f(t).call(this, e, n))).items = null), r
        );
      }
      return (
        s(t, r.default),
        u(t, [
          {
            ...
            value: function() {
              ...
              return (
                !!t &&
                (t.jsonLike ||
                  (t.type === r.Type.COMMENT && this.nodeIsJsonLike(e - 1)))
              );
            }
          },
          {
            ...
            value: function(e, t) {
              ...
              var o = e.parseNode,
                ...
                s = e.lineStart,
                f = i[t];
              this.items = [{ char: f, offset: t }];
              var c = r.default.endOfWhiteSpace(i, t + 1);
              for (f = i[c]; f && "]" !== f && "}" !== f; ) {
                switch (f) {
                  case "\n":
                    (s = c + 1),
                      (c = r.default.endOfIndent(i, s)) - s <= u &&
                        (this.error = new S.YAMLSemanticError(
                          this,
                    ...
                    break;
                  case ",":
                    this.items.push({ char: f, offset: c }), (c += 1);
                    break;
                  case "#":
                    var l = new n.default();
                    (c = l.parse({ src: i }, c)), this.items.push(l);
                    break;
                  case "?":
                  case ":":
                    var d = i[c + 1];
                  ...
                  default:
                    ...
                    this.items.push(h),
                      (c = r.default.normalizeOffset(i, h.range.end));
                }
                f = i[(c = r.default.endOfWhiteSpace(i, c))];
              }
              return (
                (this.valueRange = new a.default(t, c + 1)),
                f &&
                  (this.items.push({ char: f, offset: c }),
                  (c = r.default.endOfWhiteSpace(i, c + 1)),
          ...
          },
          {
            ...
            value: function(e, n) {
              return (
                (n = v(f(t.prototype), "setOrigRanges", this).call(this, e, n)),
                this.items.forEach(function(t) {
                  if (t instanceof r.default) n = t.setOrigRanges(e, n);
            ...
            },
            {
              ...
              get: function() {
                ...
                var e = [],
                  ...
                  u = o.src;
                '"' !== u[a - 1] &&
                  e.push(new S.YAMLSyntaxError(this, 'Missing closing "quote'));
                for (var s = "", f = r + 1; f < a - 1; ++f) {
                  var c = u[f];
                  if ("\n" === c) {
                    n.default.atDocumentBoundary(u, f + 1) &&
                      e.push(
                        new S.YAMLSemanticError(
                          this,
      ...
      function e() {
        ...
        o(this, e),
          (p = function(t, o) {
            ...
            if (
              (w <= o &&
                ((u.error = new Error("Node#parse consumed no characters")),
                (u.error.parseEnd = w),
                (u.error.source = u),
                (w = o + 1)),
              (u.range = new h.default(o, w)),
              p.nodeStartsCollection(u))
            ) {
              u.error ||
                p.atLineStart ||
                p.parent.type !== f.Type.DOCUMENT ||
                (u.error = new S.YAMLSyntaxError(
                  u,
              ...
              return (
                (b = O.parse(new e(p), b)), (O.range = new h.default(o, b)), O
              );
            }
            return u;
          }),
          ...
          (this.lineStart = null != O ? O : g.lineStart),
          (this.parent = null != E ? E : g.parent || {}),
          (this.src = g.src);
      }
      return (
        u(e, null, [
          {
            ...
            value: function(e, t, n) {
              switch (e[t]) {
                ...
                case "?":
                  return !n && f.default.atBlank(e, t + 1)
                    ? f.Type.MAP_KEY
                    : f.Type.PLAIN;
                case ":":
                  return !n && f.default.atBlank(e, t + 1)
        ...
        u(e, [
          {
            ...
            value: function(e) {
              ...
              return (
                "\n" !== r[a] &&
                "\n" !== r[a - 1] &&
                ":" === r[(a = f.default.endOfWhiteSpace(r, a))]
              );
            }
          },
          {
            ...
            value: function(t) {
              for (
                var n = this.inFlow,
                  ...
                  o = [],
                  i = !1,
                  u = a[(t = f.default.endOfWhiteSpace(a, t))];
                u === f.Char.ANCHOR ||
                u === f.Char.COMMENT ||
                u === f.Char.TAG ||
                "\n" === u;
                ...
                if ("\n" === u) {
                  ...
                  u === f.Char.TAG &&
                    ...
                    (v = f.default.endOfIdentifier(a, v + 5)),
                    o.push(new h.default(t, v)),
                    (i = !0),
                    (t = f.default.endOfWhiteSpace(a, v));
                }
                u = a[t];
              }
              return (
                i && ":" === u && f.default.atBlank(a, t + 1) && (t -= 1),
  ...
  var Q = r(function(e, t) {
    ...
    var c = (function(e) {
      function t() {
        ...
        return (
          i(
            h(h((n = p(this, (e = f(t)).call.apply(e, [this].concat(a)))))),
            "items",
            []
          ),
          n
            ...
            value: function(e, r, a) {
              ...
              var h,
                ...
                g = this.items.reduce(function(t, r, a) {
                  ...
                  return (
                    v || -1 === f.indexOf("\n") || (v = !0),
                    d && a < o.items.length - 1 && (f += ","),
                    (f = (0, n.default)(f, s, u)),
                    t.push({ type: "item", str: f }),
                    t
                  );
                }, []);
              if (0 === g.length) h = u.start + u.end;
              else if (d) {
                var m = u.start,
                  y = u.end,
                  _ = g.map(function(e) {
    ...
    (t.default = c),
      i(c, "maxFlowStringSingleLineLength", 60),
      (e.exports = t.default),
      (e.exports.default = t.default);
  });
  n(Q);
      ...
      return (
        ...
        u(t, [
          ...
          },
          {
            ...
            value: function(e, t) {
              ...
              var r = this.key,
                ...
                f = s.doc,
                l = s.indent;
              e = Object.assign({}, e, { implicitKey: !u, indent: l + "  " });
          ...
          },
          {
            ...
            set: function(e) {
              null == this.value && (this.value = new l.default(null)),
                (this.value.comment = e);
            }
          },
          {
            key: "stringKey",
      ...
      return (
        ...
        u(t, [
          ...
          },
          {
            ...
            value: function(e, n) {
              return e
                ? v(f(t.prototype), "toString", this).call(
                    this,
                    e,
                    {
      ...
      function t(e) {
        ...
        if ((o(this, t), e instanceof n.default)) {
          ...
          u instanceof a.default ||
            ((u = new a.default()).items.push(e.value),
            (u.range = e.value.range)),
            ((i = p(this, f(t).call(this, e.key, u))).range = e.range);
        ...
        u(t, [
          {
            ...
            value: function(e, n) {
              var r = this.value;
              if (r.items.length > 1)
                return v(f(t.prototype), "toString", this).call(this, e, n);
  ...
  var J = r(function(e, t) {
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function e(t) {
        ...
        var f = new n.default();
        return (
          (f.items = Object.keys(t).map(function(n) {
            var a = e(n, u),
              o = e(t[n], u);
    ...
    var i,
      ...
      d = (function(e) {
        function t(e) {
          ...
          return (
            o(this, t),
            ((n = p(this, f(t).call(this))).source = e),
            (n.type = M.Type.ALIAS),
            n
          );
        }
        ...
        (function e(t, i) {
          if (t && "object" === a(t)) {
            ...
            t instanceof n.default
              ...
              ? (e(t.key, i), e(t.value, i))
              : t instanceof o.default && u && (i[u] = !0);
          }
          return i;
        })(e, {})
      );
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function(e, t, a, o) {
        ...
        for (
          var p = [],
            v = {},
            g = s - ("number" == typeof i ? i : t.length),
            m = void 0,
            y = void 0,
            _ = !1,
            b = 0,
  ...
  var X = r(function(e, t) {
    ...
    function i(e, t) {
      var a = t.implicitKey,
        ...
        f = JSON.stringify(e);
      if (u) return f;
      for (var c = "", l = 0, d = 0, h = f[d]; h; h = f[++d])
        if (
          (" " === h &&
            "\\" === f[d + 1] &&
            "n" === f[d + 2] &&
            ((c += f.slice(l, d) + "\\ "), (l = d += 1), (h = "\\")),
          "\\" === h)
        )
          switch (f[d + 1]) {
            case "u":
      ...
      return (
        (c = l ? c + f.slice(l) : f),
        a ? c : (0, n.default)(c, o, n.FOLD_QUOTED, r.fold)
      );
    }
    function u(e, t) {
      var a = t.indent,
    ...
    function s(e, t, o) {
      ...
      var c = t.indent || (t.forceBlockIndent ? " " : ""),
        l = c ? "2" : "1",
        d =
          s !== M.Type.BLOCK_FOLDED &&
          (s === M.Type.BLOCK_LITERAL || !a(f, r.fold.lineWidth - c.length)),
        h = d ? "|" : ">";
      if (!f) return h + "\n";
      var p = "",
        v = "";
          ...
          case M.Type.PLAIN:
            return (function(e, t, a) {
              ...
              return !o ||
                ...
                (-1 === g.indexOf("\n") && -1 === o.indexOf("\n"))
                ? g
                : (a && a(), (0, F.addCommentBefore)(g, d, o));
            })(e, t, a);
          default:
            return null;
        }
      };
      d !== M.Type.QUOTE_DOUBLE && /[\x00-\x08\x0b-\x1f\x7f-\x9f]/.test(h)
        ? (d = M.Type.QUOTE_DOUBLE)
        : (!f && !c) ||
          (d !== M.Type.BLOCK_FOLDED && d !== M.Type.BLOCK_LITERAL) ||
          (d = M.Type.QUOTE_DOUBLE);
      var v = p(d);
      if (null === v && null === (v = p(o)))
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.checkKeyLength = function(e, t, n, r, a) {
        ...
        if (i > a + 1024) {
          ...
          e.push(
            new S.YAMLSemanticError(t, 'The "'.concat(f, '" key is too long'))
          );
        }
      }),
            ...
            t.type === M.Type.FLOW_MAP
                  ...
                  for (
                    ...
                    if ("string" == typeof c.char) {
                      ...
                      e.errors.push(
                        new S.YAMLSyntaxError(
                          t,
                          "Flow map contains an unexpected ".concat(l)
                        )
                      );
                    } else
                      c.type === M.Type.COMMENT
                        ...
                        : ("," !== s &&
                          ...
                          r.push(new o.default(a, e.resolveNode(c))),
                          (a = void 0),
                          (u = !1));
                  }
                  "}" !== t.items[t.items.length - 1].char &&
                    e.errors.push(
                      new S.YAMLSemanticError(
                        t,
              ...
              : (function(e, t) {
                  for (
                    ...
                    switch (f.type) {
                      case M.Type.COMMENT:
                        r.push({ comment: f.comment, before: a.length });
                        break;
                      case M.Type.MAP_KEY:
                      ...
                      case M.Type.MAP_VALUE:
                        ...
                        if (!c && f.props.length > 0) {
                          ...
                          (c.range = { start: l, end: l }),
                            (c.valueRange = { start: l, end: l }),
                            "number" == typeof f.range.origStart &&
                              ((c.range.origStart = c.range.origEnd = d),
                              (c.valueRange.origStart = c.valueRange.origEnd = d));
                        }
                        a.push(new o.default(i, e.resolveNode(c))),
                          (0, ee.checkKeyLength)(e.errors, t, s, i, u),
                          (i = void 0),
                          (u = null);
                        break;
                      default:
        ...
        for (var d = 0; d < c.length; ++d) {
          ...
          if (e.schema.merge && h && h.value === a.MERGE_KEY) {
            ...
            for (var g = d + 1; g < c.length; ++g) {
              ...
              if (
                h === m ||
                (h && m && h.hasOwnProperty("value") && h.value === m.value)
              ) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.default = function(e, t) {
        ...
        var o =
            t.type === M.Type.FLOW_SEQ
              ? (function(e, t) {
                  for (
                    ...
                    if ("string" == typeof c.char) {
                    ...
                    } else if (c.type === M.Type.COMMENT)
                      r.push({ comment: c.comment, before: a.length });
                    else {
                      if (s) {
                        var h = "Expected a ".concat(
                          s,
                          " here in flow sequence"
                        );
                      ...
                      void 0 === i
                        ? a.push(p)
                        : (a.push(new n.default(i, p)), (i = void 0)),
                        (u = c.range.start),
                        (s = ",");
                    }
                  }
          ...
          s = new r.default();
        return (
          (s.items = u), (0, ee.resolveComments)(s, i), (t.resolved = s), s
        );
      });
    var n = a(V),
      r = a(K);
  ...
  var ae = r(function(e, t) {
    ...
    var n,
      r = (n = re) && n.__esModule ? n : { default: n };
    var a = function(e) {
      var t = e.value;
      return isFinite(t)
        ? JSON.stringify(t)
  ...
  function he(e) {
    ...
    ce || le();
    for (
      var n = e.length, r = n % 3, a = "", o = [], i = 0, u = n - r;
      i < u;
      i += 16383
    )
      o.push(de(e, i, i + 16383 > u ? u : i + 16383));
    return (
      1 === r
        ? ((t = e[n - 1]),
          (a += ue[t >> 2]),
  ...
  function pe(e, t, n, r, a) {
    var o,
      ...
      h = e[t + l];
    for (
      l += d, o = h & ((1 << -c) - 1), h >>= -c, c += u;
      c > 0;
      o = 256 * o + e[t + l], l += d, c -= 8
    );
    for (
      i = o & ((1 << -c) - 1), o >>= -c, c += r;
      c > 0;
      ...
      t = Math.abs(t),
        isNaN(t) || t === 1 / 0
          ...
          : ((i = Math.floor(Math.log(t) / Math.LN2)),
            ...
            (t += i + l >= 1 ? d / s : d * Math.pow(2, 1 - l)) * s >= 2 &&
              (i++, (s /= 2)),
            i + l >= c
              ? ((u = 0), (i = c))
              : i + l >= 1
              ? ((u = (t * s - 1) * Math.pow(2, a)), (i += l))
              : ((u = t * Math.pow(2, l - 1) * Math.pow(2, a)), (i = 0)));
      a >= 8;
      e[n + h] = 255 & u, h += p, u /= 256, a -= 8
    );
    for (
      i = (i << a) | u, f += a;
      f > 0;
  ...
  function _e(e, t) {
    ...
    return (
      be.TYPED_ARRAY_SUPPORT
        ? ((e = new Uint8Array(t)).__proto__ = be.prototype)
        : (null === e && (e = new be(t)), (e.length = t)),
      e
    );
  }
  function be(e, t, n) {
  ...
  function Ee(e, t) {
    if ((Oe(t), (e = _e(e, t < 0 ? 0 : 0 | Se(t))), !be.TYPED_ARRAY_SUPPORT))
  ...
  function Le(e, t, n, r, a) {
    ...
    if (("string" == typeof t && (t = be.from(t, r)), Ae(t)))
      return 0 === t.length ? -1 : ke(e, t, n, r, a);
    if ("number" == typeof t)
      return (
        (t &= 255),
        be.TYPED_ARRAY_SUPPORT &&
  ...
  function Be(e, t, n) {
    ...
    return (function(e) {
      ...
      var n = "",
        r = 0;
      for (; r < t; )
        n += String.fromCharCode.apply(String, e.slice(r, (r += Ye)));
      return n;
    })(r);
  }
  (be.TYPED_ARRAY_SUPPORT =
    void 0 === ie.TYPED_ARRAY_SUPPORT || ie.TYPED_ARRAY_SUPPORT),
    (be.poolSize = 8192),
    (be._augment = function(e) {
    ...
    be.TYPED_ARRAY_SUPPORT &&
      ((be.prototype.__proto__ = Uint8Array.prototype),
      (be.__proto__ = Uint8Array),
      "undefined" != typeof Symbol && Symbol.species && be[Symbol.species]),
    (be.alloc = function(e, t, n) {
    ...
    (be.byteLength = Pe),
    (be.prototype._isBuffer = !0),
    (be.prototype.swap16 = function() {
      var e = this.length;
      if (e % 2 != 0)
  ...
  (be.prototype.slice = function(e, t) {
    ...
    if (
      ...
      (n = this.subarray(e, t)).__proto__ = be.prototype;
    else {
      var a = t - e;
      n = new be(a, void 0);
    ...
    (be.prototype.writeUIntLE = function(e, t, n, r) {
      ((e = +e), (t |= 0), (n |= 0), r) ||
        Ke(this, e, t, n, Math.pow(2, 8 * n) - 1, 0);
      var a = 1,
        o = 0;
    ...
    (be.prototype.writeUInt8 = function(e, t, n) {
      return (
        ...
        be.TYPED_ARRAY_SUPPORT || (e = Math.floor(e)),
        (this[t] = 255 & e),
        t + 1
      );
    }),
    ...
    (be.prototype.copy = function(e, t, n, r) {
      ...
      else if (o < 1e3 || !be.TYPED_ARRAY_SUPPORT)
    ...
    (be.prototype.fill = function(e, t, n, r) {
      if ("string" == typeof e) {
        ...
        if ("string" == typeof r && !be.isEncoding(r))
  ...
  function et(e) {
    return (function(e) {
      ...
      for (t = 0, n = 0; t < r; t += 4, n += 3)
        (a =
          (se[e.charCodeAt(t)] << 18) |
          (se[e.charCodeAt(t + 1)] << 12) |
          (se[e.charCodeAt(t + 2)] << 6) |
          se[e.charCodeAt(t + 3)]),
          (i[s++] = (a >> 16) & 255),
          (i[s++] = (a >> 8) & 255),
          (i[s++] = 255 & a);
      return (
        2 === o
          ? ((a = (se[e.charCodeAt(t)] << 2) | (se[e.charCodeAt(t + 1)] >> 4)),
            (i[s++] = 255 & a))
          : 1 === o &&
            ((a =
              (se[e.charCodeAt(t)] << 10) |
              (se[e.charCodeAt(t + 1)] << 4) |
              (se[e.charCodeAt(t + 2)] >> 2)),
            (i[s++] = (a >> 8) & 255),
            (i[s++] = 255 & a)),
        i
      );
  ...
  var rt = r(function(e, t) {
    ...
    var n = {
      ...
      options: { defaultType: M.Type.BLOCK_LITERAL, lineWidth: 76 },
      stringify: function(e, t, r) {
        ...
        if (
          ((a =
            u instanceof be
              ? u.toString("base64")
              : be.from(u.buffer).toString("base64")),
          i || (i = n.options.defaultType),
          i === M.Type.QUOTE_DOUBLE)
        )
          u = a;
        else {
          for (
            var s = n.options.lineWidth,
              f = Math.ceil(a.length / s),
              c = new Array(f),
              l = 0,
              d = 0;
            l < f;
        ...
        return (0, X.stringify)({ comment: o, type: i, value: u }, t, r);
      }
    };
    t.binary = n;
    var r = [n];
      ...
      function e(t) {
        ...
        if (
          ...
          var i = Object.keys(g)
            ...
            .join(", ");
          throw new Error(
            "Unknown schema; use ".concat(i, ", or { tag, test, resolve }[]")
          );
        }
        Array.isArray(a)
          ? (this.schema = this.schema.concat(a))
          : "function" == typeof a && (this.schema = a(this.schema.slice()));
      }
      return (
        u(e, null, [
          {
        ...
        u(e, [
          {
            ...
            value: function(e, t) {
              ...
              return (
                this.schema.scalarFallback &&
                  (e = this.schema.scalarFallback(e)),
                new h.default(e)
              );
            }
          },
          {
            ...
            value: function(e, t, n) {
              ...
              try {
                if (a) {
                  var o = a.resolve(e, t);
                  o instanceof i.default || (o = new h.default(o)),
                    (t.resolved = o);
                } else {
                  var u = (0, X.resolve)(e, t);
                  "string" == typeof u &&
                    r.length > 0 &&
                    (t.resolved = this.resolveScalar(u, r));
                }
              } catch (n) {
                n.source || (n.source = t),
                  e.errors.push(n),
          ...
          },
          {
            ...
            value: function(e, t, n) {
              ...
              var a,
                o =
                  (a = t.type) === M.Type.FLOW_MAP || a === M.Type.MAP
                    ? m.MAP
                    : (function(e) {
                        var t = e.type;
              ...
              return (
                e.errors.push(
                  new S.YAMLReferenceError(
                    t,
                    "The tag ".concat(n, " is unavailable")
                  )
                ),
                null
              );
          ...
          },
          {
            ...
            value: function(t, r, a) {
              if (
                (t instanceof l.default || (t = (0, n.default)(t, !0)),
                (r.tags = this),
              ...
              var o = this.getTagObject(t),
                ...
                f = s(t, r, a);
              return u
                ? t instanceof i.default && "{" !== f[0] && "[" !== f[0]
                  ? ""
                      .concat(u, "\n")
                      .concat(r.indent)
                      .concat(f)
          ...
          u(e, [
              ...
              value: function(e) {
                ...
                r.forEach(function(e) {
                  ...
                  switch (r) {
                    ...
                    default:
                      if (r) {
                        var a = "YAML only supports %TAG and %YAML directives, and not %".concat(
                          r
                        );
                ...
                switch (
                  ...
                  case 1:
                    if (((this.contents = l[0]), this.contents)) {
                      ...
                      if (d) {
                        var h =
                          this.contents instanceof f.default &&
                    ...
                    (this.contents = l),
                      this.contents[0]
                        ? (this.contents[0].commentBefore =
                            c.before.join("\n") || null)
                        : (c.after = c.before.concat(c.after));
                }
                return (
                  (this.comment = c.after.join("\n") || null),
            ...
            },
            {
              ...
              value: function(e) {
                ...
                if (t) {
                  ...
                  if (u) {
                    if ("!" !== u && "!!" !== u) return u;
                    var s = "Verbatim tags aren't resolved, so ".concat(
                      u,
                      " is invalid."
                    );
            ...
            },
            {
              ...
              value: function(e) {
                ...
                if (e.type === M.Type.ALIAS) {
                  ...
                  if (
                    ((t = new s.default(d)), n._cstAliases.push(t), !d.resolved)
                  ) {
                    this.warnings.push(
                      new S.YAMLWarning(
                        e,
                  ...
                  if (p) t = a.resolveNodeWithFallback(this, e, p);
                  else {
            ...
            },
            {
              ...
              value: function() {
                ...
                return (
                  this.comment && e.push(this.comment.replace(/^/gm, "#")),
                  e.join("\n") + "\n"
                );
              }
            }
                  ...
                  if (
                    ...
                    for (
                      var u = n.position,
                        r = u.start,
                        o = u.end,
                        s = [o.line].concat(r.line === o.line ? [] : r.line),
                        f = 0,
                        c = s;
                      f < c.length;
                      f++
          ...
          .forEach(function(e) {
            ...
            !(function(e, t, r) {
                ...
                if (o.trailingComment)
                  throw new Error(
                    "Unexpected multiple trailing comment at " +
                      ct.getPointText(e.position.start)
                  );
              ...
              for (var i = a; i >= r.position.start.line; i--) {
                ...
                for (;;) {
                  if (n(s, e))
                    return ft.defineParents(e, s), void s.endComments.push(e);
                  if (!s._parent) break;
                  s = s._parent;
                }
                break;
              ...
              for (var i = a + 1; i <= r.position.end.line; i++) {
                ...
                if (f)
                  return ft.defineParents(e, f), void f.leadingComments.push(e);
              }
              var c = r.children[1];
    ...
    (t.__esModule = !0),
      (t.createCommentAttachable = function() {
        return w.__assign(
          ...
          vt.createTrailingCommentAttachable()
        );
      });
  });
  n(gt);
  var mt = r(function(e, t) {
    (t.__esModule = !0),
      (t.createAlias = function(e, t, n) {
        return w.__assign(
          {},
          dt.createNode("alias", e),
          gt.createCommentAttachable(),
          t,
          { value: n }
        );
      });
  ...
  var _t = r(function(e, t) {
    (t.__esModule = !0),
      (t.createBlockFolded = function(e) {
        return w.__assign({}, e, { type: "blockFolded" });
      });
  });
  n(_t);
  ...
  var Ot = r(function(e, t) {
    (t.__esModule = !0),
      (t.createAnchor = function(e, t) {
        return w.__assign({}, dt.createNode("anchor", e), { value: t });
      });
  });
  n(Ot);
  var Et = r(function(e, t) {
    (t.__esModule = !0),
      (t.createComment = function(e, t) {
        return w.__assign({}, dt.createNode("comment", e), { value: t });
      });
  });
  n(Et);
  var Mt = r(function(e, t) {
  ...
  var St = r(function(e, t) {
    (t.__esModule = !0),
      (t.createTag = function(e, t) {
        return w.__assign({}, dt.createNode("tag", e), { value: t });
      });
  });
  n(St);
  var At = r(function(e, t) {
        ...
        for (
          ...
          switch (l) {
            ...
            case wt.PropLeadingCharacter.Anchor:
              (o = o || c),
                (u = Ot.createAnchor(t.transformRange(c), r.anchor));
              break;
            case wt.PropLeadingCharacter.Comment:
              var d = Et.createComment(
                t.transformRange(c),
                t.text.slice(c.origStart + 1, c.origEnd)
              );
              t.comments.push(d),
                !n(d) &&
                  o &&
                  o.origEnd <= c.origStart &&
                  c.origEnd <= r.valueRange.origStart &&
                  a.push(d);
              break;
            default:
              throw new Error(
                "Unexpected leading character " + JSON.stringify(l)
              );
          }
        }
  ...
  var Lt = r(function(e, t) {
    (t.__esModule = !0),
      (t.createBlockLiteral = function(e) {
        return w.__assign({}, e, { type: "blockLiteral" });
      });
  });
  n(Lt);
  ...
  var Nt = r(function(e, t) {
    (t.__esModule = !0),
      (t.transformDirective = function(e, t) {
        return (
          Rt.extractPropComments(e, t),
          Ct.createDirective(t.transformRange(e.range), e.name, e.parameters)
        );
      });
  });
  n(Nt);
  var It = r(function(e, t) {
    (t.__esModule = !0),
      (t.createDocument = function(e, t, n, r) {
        return w.__assign(
          {},
          dt.createNode("document", e),
          vt.createTrailingCommentAttachable(r),
          { children: [t, n] }
        );
      });
  });
  ...
  var Bt = r(function(e, t) {
    (t.__esModule = !0),
      (t.createDocumentBody = function(e, t, n) {
        return w.__assign(
          {},
          dt.createNode("documentBody", e),
          jt.createEndCommentAttachable(n),
          { children: t ? [t] : [] }
        );
      });
  });
  ...
  var Ut = r(function(e, t) {
    (t.__esModule = !0),
      (t.transformDocumentBody = function(e, t, n) {
            ...
            if (o.length > 1)
              throw new Error(
                "Unexpected multiple document trailing comments at " +
                  ct.getPointText(o[1].position.start)
              );
            if (i.length > 1)
              throw new Error(
                "Unexpected multiple documentHead trailing comments at " +
                  ct.getPointText(i[1].position.start)
              );
            return {
              comments: r,
              endComments: a,
        ...
        return (
          (r = t.comments).push.apply(r, i.concat(u)),
          {
    ...
    (t.__esModule = !0),
      (t.transformDocumentHead = function(e, t) {
        var n,
          ...
          c = s.endMarkerPoint;
        return (
          (n = t.comments).push.apply(n, i.concat(u)),
          {
  ...
  var Vt = r(function(e, t) {
    (t.__esModule = !0),
      (t.transformDocument = function(e, t) {
        ...
        return (
          s && t.comments.push(s),
          It.createDocument(Dt.createPosition(f.position.start, u), f, i, s)
        );
      });
  });
  n(Vt);
  var Kt = r(function(e, t) {
    (t.__esModule = !0),
      (t.createFlowCollection = function(e, t, n) {
        return w.__assign(
          {},
          dt.createNode("flowCollection", e),
          gt.createCommentAttachable(),
          t,
          { children: n }
        );
  ...
  var qt = r(function(e, t) {
    (t.__esModule = !0),
      (t.createFlowMappingItem = function(e, t, n) {
        return w.__assign(
          {},
          dt.createNode("flowMappingItem", e),
          pt.createLeadingCommentAttachable(),
          { children: [t, n] }
        );
      });
  ...
  var zt = r(function(e, t) {
    (t.__esModule = !0),
      (t.groupCstFlowCollectionItems = function(e) {
        for (
          var t = [], n = Ht.createSlicer(e, 1), r = !1, a = 1;
          a < e.length - 1;
          a++
        ) {
          var o = e[a];
  ...
  var en = r(function(e, t) {
    (t.__esModule = !0),
      (t.transformAstPair = function(e, t, n, r, a) {
        ...
        return n(
          Dt.createPosition(
            u ? u.position.start : s.position.start,
            s ? s.position.end : u.position.end
          ),
          u ||
            Zt.createMappingKey(Dt.createEmptyPosition(s.position.start), null),
          s ||
            Xt.createMappingValue(Dt.createEmptyPosition(u.position.end), null)
        );
      });
  });
  n(en);
        ...
        var n = Jt.extractComments(e.cstNode.items, t),
          ...
          a = e.items.map(function(e, n) {
            if ("PAIR" !== e.type) {
              ...
              return rn.createFlowSequenceItem(
                Dt.createPosition(a.position.start, a.position.end),
                a
              );
            }
            var o = r[n],
  ...
  var sn = r(function(e, t) {
    (t.__esModule = !0),
      (t.transformMap = function(e, t) {
        ...
        var r = (function(e) {
            for (
              var t = [], n = Ht.createSlicer(e, 0), r = !1, a = 0;
              a < e.length;
              a++
            ) {
              var o = e[a];
        ...
        return on.createMapping(
          Dt.createPosition(a[0].position.start, Yt.getLast(a).position.end),
          t.transformContent(e),
          a
        );
      });
  ...
  var ln = r(function(e, t) {
    (t.__esModule = !0),
      (t.transformPlain = function(e, t) {
        var n = e.cstNode;
        return fn.createPlain(
          t.transformRange({
            origStart: n.valueRange.origStart,
            origEnd:
              cn.findLastCharIndex(t.text, n.valueRange.origEnd - 1, /\S/) + 1
          }),
          t.transformContent(e),
          n.strValue
        );
  ...
  var dn = r(function(e, t) {
    (t.__esModule = !0),
      (t.createQuoteDouble = function(e) {
        return w.__assign({}, e, { type: "quoteDouble" });
      });
  });
  n(dn);
  ...
  var gn = r(function(e, t) {
    (t.__esModule = !0),
      (t.createQuoteSingle = function(e) {
        return w.__assign({}, e, { type: "quoteSingle" });
      });
  });
  n(gn);
  ...
  var bn = r(function(e, t) {
    (t.__esModule = !0),
      (t.transformSeq = function(e, t) {
        ...
        return yn.createSequence(
          Dt.createPosition(n[0].position.start, Yt.getLast(n).position.end),
          t.transformContent(e),
          n
        );
      });
        ...
        if (null !== t && "children" in t) {
          ...
          if ((s.forEach(e), "document" === t.type)) {
            ...
            c.position.start.offset === c.position.end.offset
              ? (c.position.start = c.position.end = l.position.start)
              : l.position.start.offset === l.position.end.offset &&
                (l.position.start = l.position.end = c.position.end);
          }
          ...
          "endComments" in t &&
            ...
            h(Yt.getLast(t.endComments).position.end));
    ...
    (t.__esModule = !0),
      (t.parse = function(e) {
        ...
        var n = t.map(function(e) {
            return new st.Document({ merge: !0, keepCstNodes: !0 }).parse(e);
          }),
          r = [],
          a = {
            text: e,
        ...
        return (
          lt.attachComments(i), kn.updatePositions(i), Tn.removeFakeNodes(i), i
        );
      });
  });
  n(xn);
